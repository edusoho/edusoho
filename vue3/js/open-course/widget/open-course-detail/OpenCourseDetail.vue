    ...
    <div class="px-32">
      <a-tabs v-model:activeKey="activeKey" centered>
        <a-tab-pane key="intro" tab="简介">
          <div v-if="props.course.about" v-html="props.course.about" class="mt-8 mb-24"></div>
              ...
              <div class="flex justify-between my-24">
                <div class="flex flex-col">
                  ...
                  <div class="flex items-center mr-16">
                    ...
                    <div class="text-14 mr-16 font-normal" :class="{ 'text-[#87898F]': lesson.progressStatus !== 'live', 'text-[--primary-color]': lesson.progressStatus === 'live' }">{{ lesson.progressStatus === 'live' ? '进行中' : lesson.progressStatus === 'created' ? '未开始' : '已结束' }}</div>
                ...
                <div class="flex items-center">
                  <a-button type="primary" ghost v-if="lesson.type === 'liveOpen'">查看直播</a-button>
                  <a-button type="primary" ghost v-if="lesson.type === 'replay'">查看回放</a-button>
                </div>
              </div>
