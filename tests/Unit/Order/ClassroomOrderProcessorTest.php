...
use Biz\Order\OrderProcessor\ClassroomOrderProcessor;
...
class ClassroomOrderProcessorTest extends BaseTestCase
{
    public function testPreCheckWithBecomedStudent()
    {
        ...
        $processor = $this->getClassroomOrderProcessor();
...
//        $this->getCourseService()->setCoursePrice($createCourse['id'], 'default', 100.00);
    ...
    public function testGetNote()
    {
        ...
        $processor = $this->getCourseOrderProcessor();
    ...
    protected function getClassroomOrderProcessor()
    {
        return new ClassroomOrderProcessor($this->getBiz());
    }
