...
class SearchKeywordTypeTest extends BaseTestCase
{
    public function testPackages()
    {
        ...
        $statements = array(
            array('user_id' => 1, 'uuid' => 10, 'occur_time' => time(), 'data' => array('q' => 'PHP基础入门', 'type' => 'course', 'uri' => '/cloud/search?q=PHP基础入门&type=course')),
            array('user_id' => 2, 'uuid' => 20, 'occur_time' => time(), 'data' => array('q' => 'Java入门班', 'type' => 'classroom', 'uri' => '/cloud/search?q=Java入门班&type=classroom')),
            array('user_id' => 3, 'uuid' => 30, 'occur_time' => time(), 'data' => array('q' => '张艺谋', 'type' => 'teacher', 'uri' => '/cloud/search?q=张艺谋&type=teacher')),
            array('user_id' => 4, 'uuid' => 40, 'occur_time' => time(), 'data' => array('q' => '如何拥有超能力', 'type' => 'article', 'uri' => '/search?q=如何拥有超能力&type=article')),
            array('user_id' => 5, 'uuid' => 50, 'occur_time' => time(), 'data' => array('q' => '怎么走上人生巅峰', 'type' => 'thread', 'uri' => '/cloud/search?q=怎么走上人生巅峰&type=thread')),
        );
