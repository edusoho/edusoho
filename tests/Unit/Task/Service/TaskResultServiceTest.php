...
class TaskResultServiceTest extends BaseTestCase
{
    ...
    {
        $this->mockTaskResult(['userId' => 1, 'time' => 100, 'pureTime' => 200, 'watchTime' => 100, 'pureWatchTime' => 200, 'courseTaskId' => 1]);
        $this->mockTaskResult(['userId' => 2, 'time' => 200, 'pureTime' => 400, 'watchTime' => 200, 'pureWatchTime' => 400, 'courseTaskId' => 1]);
        $this->mockTaskResult(['userId' => 1, 'time' => 100, 'pureTime' => 100, 'watchTime' => 100, 'pureWatchTime' => 100, 'courseTaskId' => 2]);
        ...
        $result = $this->getTaskResultService()->sumLearnedTimeByCourseTaskId(1);
    ...
    public function testSumWatchTimeByCourseTaskId()
    {
        ...
        $result = $this->getTaskResultService()->sumWatchTimeByCourseTaskId(1);
        $this->assertEquals(600, $result);
