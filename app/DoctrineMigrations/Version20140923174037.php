...
class Version20140923174037 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        $this->addSql("ALTER TABLE `class_member` 
        	ADD `lastRank` INT(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '上次排名' AFTER `title`,
        	ADD `currentRank` INT(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '这次排名' AFTER `lastRank`,
