...
class Version20160927142136 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql(" UPDATE `course_member` SET `lastLearnTime` = (SELECT max(startTime) FROM `course_lesson_learn` WHERE course_member.courseId = course_lesson_learn.courseId);");
