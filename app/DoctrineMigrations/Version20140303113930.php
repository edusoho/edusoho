...
class Version20140303113930 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
	        CREATE TABLE IF NOT EXISTS `teacher_commission_setting` (
				  ...
				  `managerId` int(11) NOT NULL DEFAULT '0' COMMENT '管理人员Id',
	  				PRIMARY KEY (`id`)
			) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='老师佣金设置表' AUTO_INCREMENT=1;
		");
		...
		$this->addSql("
	        CREATE TABLE IF NOT EXISTS `teacher_commission` (
				  ...
				  `tcsId` int(11) NOT NULL COMMENT '老师佣金设置Id',
				  `buyerId` int(11) NOT NULL COMMENT '购买人Id',
				  `teacherId` int(11) NOT NULL COMMENT '佣金所属人',
				  ...
				  PRIMARY KEY (`id`)
				) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='老师佣金记录表' AUTO_INCREMENT=1;
		");
