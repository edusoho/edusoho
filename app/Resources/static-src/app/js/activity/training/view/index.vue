                ...
                <div slot="left" class="left-box">
                    ...
                    <div class="box-container relative">
                        <div class="left-bar">
                            <div class="left-bar">
                                <div class="menu-tabs">
                                    <div class="item font-16" :class=" tab == 'document'?'active':'' "
                                         @click="switchTab('document')">实验手册
                                    </div>
                                    <div class="item font-16" :class=" tab == 'dataset'?'active':''"
                                         @click="switchTab('dataset')">我的数据集
                                    </div>
                                </div>
                                            ...
                                            <div class="body-con dataSet" v-show="tab=='dataset'">
                                                <el-collapse v-model="activeNames">
                                                    <el-collapse-item :title="item.name"
                                                                      v-for="item in bindInfo['datasets']"
                                                                      :key="item.id">
                                                        <ul>
                                                            <li style="cursor:pointer"
                                                                @click="copyPath(item.mount_path,file.name)"
