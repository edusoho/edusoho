<template>
    <div>
        ...
        <span v-else>
            <span class="product-detail__disable_btn goods-btn-hove" v-if="(sku.vipLevelInfo && !sku.vipUser) || sku.vipLevelInfo && sku.vipUser && sku.vipLevelInfo.seq > sku.vipUser.level.seq">
                <slot>会员免费学</slot>
