        ...
        <div class="product-info clearfix" v-if="goods.id">
            <div class="product-info__left info-left pull-left">
                ...
                <div class="info-left__content">
                    <div id="info-left-1" class="content-item js-content-item" style="scroll-margin-top: 100px;">
                    ...
                    <div id="info-left-2" style="scroll-margin-top: 100px; background-color: #FFF; margin-top: 24px; padding: 16px 24px; display: flex; flex-direction: column;">
                    ...
                    <div v-if="ugcReviewSetting.enable_review == 1
                                 && ((ugcReviewSetting.enable_course_review == 1 && goods.type == 'course') || (ugcReviewSetting.enable_classroom_review == 1 && goods.type == 'classroom'))" id="info-left-4" class="info-left-reviews content-item js-content-item reviews" style="scroll-margin-top: 100px;">
