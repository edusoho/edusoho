...
class Live {
  ...
  entryRoom(roomUrl) {
    ...
    let html = '<iframe name="classroom" src="' + roomUrl + '" style="position:absolute; left:0; top:0; height:100%; width:100%; border:0px;" scrolling="no" allowfullscreen="true" allow="microphone; camera" allow="screen-wake-lock"></iframe>';
    $('body').html(html);
  }
