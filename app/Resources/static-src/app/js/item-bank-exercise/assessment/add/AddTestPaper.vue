...
<template>
  <div>
    <a-button @click="drawerVisible = true">{{ 'item_bank_exercise.addTestpaper'|trans }}</a-button>
    <a-drawer
    ...
    >
      <div class="condition-bar">
        ...
        <a-button @click="type = undefined; keywordType = 'name'; keyword = undefined;">{{ 'question.bank.reset.btn'|trans }}</a-button>
      </div>
      <a-table
        :columns="columns"
