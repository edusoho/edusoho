      ...
      inspectionList: [
        {
          ...
          activityInfo: {
            ...
            fromUserId: "2",
            copyId: "0",
            startTime: "1628735940",
            endTime: "1628737740",
            createdTime: "1628735643",
            updatedTime: "0",
            finishType: "join",
            finishData: "0",
            syncId: "0",
            ext: {
              ...
              liveId: "808679", //直播id
              liveProvider: "13",
              replayStatus: "ungenerated", //回放状态('ungenerated'：未生成,'generating'：生成中,'generated'：已生成,'videoGenerated'：上传回放文件)
              progressStatus: "created", //直播进行状态
              mediaId: "0",
              roomType: "large",
              roomCreated: "1",
              fileIds: [],
          ...
          liveInfo: {
            ...
            status: "unstart|living|finished",
            currentOnlineNum: 55,
            viewerOnlineNum: 55,
            speakers: [
              {
