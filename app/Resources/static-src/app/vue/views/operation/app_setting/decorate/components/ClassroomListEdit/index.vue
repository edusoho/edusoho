<template>
  <edit-layout>
    ...
    <div class="design-editor">
      ...
      <div class="design-editor__item">
        <span class="design-editor__label">{{ 'decorate.class_source' | trans }}：</span>
        <a-radio-group
      ...
      <div v-show="moduleData.sourceType === 'custom'" class="design-editor__item">
        <span class="design-editor__label design-editor__required">{{ 'decorate.class_classification' | trans }}：</span>
        <a-button @click="handleSelect">{{ 'decorate.select_class' | trans }}</a-button>
      </div>
      ...
      <div class="design-editor__item" v-show="moduleData.sourceType === 'condition'">
        <span class="design-editor__label">{{ 'decorate.class_classification' | trans }}：</span>
        <a-cascader
          style="width: 240px;"
          :options="options"
          change-on-select
