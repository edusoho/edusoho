...
require_once 'dao/audio_activity_dao.php';

use Biz\Activity\Config\Activity;
use Biz\CloudPlatform\Client\CloudAPIIOException;
use Biz\File\Service\UploadFileService;
use AppBundle\Common\ArrayToolkit;
use audio\dao\audio_activity_dao;

class activity_audio extends Activity
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->createDao(new audio_activity_dao($this->getBiz()));
    }
