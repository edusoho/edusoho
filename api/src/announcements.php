...
$api->get('/', function (Request $request) {
    ...
    $announcements = ServiceKernel::instance()->getBiz()->service('Announcement:AnnouncementService')->searchAnnouncements(array('targetType'=>$targetType,'targetId'=>$targetId),array('createdTime','DESC'),$start,$limit);
