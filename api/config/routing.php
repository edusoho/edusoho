...
$app->get(_u('/courses/category/show'), 'res.Courses:categoryShow');
...
$app->get(_u('/classrooms/category/show'), 'res.Classrooms:categoryShow');
...
$app->get(_u('/category/show'), 'res.MobileCategoryShow:get');
