...
class AddShowable extends Migration
{
    ...
    public function up()
    {
        ...
        $biz['db']->exec("
            ...
            ALTER TABLE `goods_specs` ADD COLUMN `display` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否开放逻辑展示' AFTER `buyable`;
            ...
            update goods_specs set display = 0 where status = 'unpublished';
        ");
    }
    ...
    public function down()
    {
        ...
        $biz['db']->exec('
            ...
            ALTER TABLE `goods_specs` DROP COLUMN `display`;
        ');
    }
}
