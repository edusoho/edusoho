    ...
    public function up()
    {
        $sql = "
            ...
            CREATE TABLE IF NOT EXISTS `course` (
              ...
              `maxStudentNum` int(11) NOT NULL DEFAULT '0' COMMENT '直播课程最大学生数上线',
              ...
              `showStudentNumType` enum('opened','closed') NOT NULL DEFAULT 'opened' COMMENT '学生数显示模式',
            ...
            CREATE TABLE IF NOT EXISTS `course_lesson_learn` (
              `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '学生课时学习记录ID',
            ...
            CREATE TABLE IF NOT EXISTS `course_member` (
              ...
              `levelId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户以会员的方式加入课程学生时的会员ID',
              `learnedNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '已学课时数',
              `credit` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '学生已获得的学分',
