...
class AddMultiClassGroup extends Migration
{
    ...
    public function up()
    {
        ...
        $biz['db']->exec("
            ...
            ALTER TABLE `multi_class` ADD COLUMN `status` varchar(32) not null default '' COMMENT '状态' after `productId`;
            ALTER TABLE `multi_class` ADD COLUMN `type` varchar(32) not null default 'normal' COMMENT '班课或者分组班课(normal, group)' after `status`;
