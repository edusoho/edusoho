...
class AddMultiClassGroup extends Migration
{
    ...
    public function up()
    {
        ...
        $biz['db']->exec("
            ...
            ALTER TABLE `multi_class` ADD COLUMN `start_time` varchar(32) not null default '0' COMMENT '状态' after `productId`;
            ALTER TABLE `multi_class` ADD COLUMN `end_time` varchar(32) not null default '0' COMMENT '状态' after `start_time`;
