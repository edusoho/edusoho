    ...
    public function up()
    {
        ...
        $connection->exec("
            CREATE TABLE IF NOT EXISTS `user_learn_statistics_daily` (
                ...
                `exitClassroomCourseSetNum` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT '当天退出的班级课程数',
                ...
                `exitClassroomCourseNum` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT '当天退出的班级计划数',
            ...
            CREATE TABLE IF NOT EXISTS `user_learn_statistics_total` (
                ...
                `exitClassroomCourseSetNum` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT '退出的班级课程数',
                ...
                `exitClassroomCourseNum` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT '退出的班级计划数',
                `learnedSeconds` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT '学习时长',
