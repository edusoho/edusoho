    ...
    public function up()
    {
        ...
        $connection->exec("
            CREATE TABLE IF NOT EXISTS `user_learn_statistics_daily` (
                ...
                `exitClassroomCourseNum` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT '当天退出的班级数',
                `exitCourseNum` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT '当天退出的非班级课程数',
                `exitCoursePlanNum` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT '当天退出的非班级计划数',
