...
class AlterActivityLive extends Migration
{
    ...
    public function up()
    {
        ...
        $biz['db']->exec("
            ...
            ALTER TABLE `activity_live` ADD COLUMN `liveStartTime` int(10) NOT NULL DEFAULT 0 COMMENT '直播开始时间' AFTER `progressStatus`;
            ...
            ALTER TABLE `activity_live` ADD COLUMN `replayPublic` tinyint(4) NOT NULL DEFAULT 0 COMMENT '回放是否共享';
