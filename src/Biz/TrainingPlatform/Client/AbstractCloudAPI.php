...
namespace Biz\TrainingPlatform\Client;
...
class AbstractCloudAPI
{
    ...
    protected $userAgent = 'API Client 1.0';
    ...
    public function get($uri, array $params = array(), array $header = array())
    {
        ...
        return $this->_request('GET', $uri, $options,$header);
    }
    ...
    protected function _request($method, $uri, $params,$header)
    {
        $requestId = substr(md5(uniqid('', true)), -16);

        $url = $this->apiUrl.'/'.$uri;
        $params['query']['access_token'] = '7c6011f4-5175-4f1b-8c83-fae11b01f836';
        ...
        if($res->getStatusCode() == 200){
            ...
            return json_encode(['status'=>"5000000"]);
        }
    }
