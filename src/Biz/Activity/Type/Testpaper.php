...
class Testpaper extends Activity
{
    ...
    const EXAM_MODE_AUTO_SIMULATION = 0;
    ...
    public function create($fields)
    {
        ...
        try {
            ...
            $answerScene = $this->getAnswerSceneService()->create([
                ...
                'exam_mode' => empty($fields['exam_mode']) ? self::EXAM_MODE_AUTO_SIMULATION : $fields['exam_mode'],
            ]);
    ...
    public function update($targetId, &$fields, $activity)
    {
        ...
        try {
            ...
            $answerScene = $this->getAnswerSceneService()->update($activity['answerScene']['id'], [
                ...
                'exam_mode' => empty($filterFields['exam_mode']) ? self::EXAM_MODE_AUTO_SIMULATION : $filterFields['exam_mode'],
            ]);
