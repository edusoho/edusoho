    ...
    public static function templates()
    {
        return [
            self::TEMPLATE_GROUPON_CREATE => [
                ...
                'smsDetail' => [SmsType::GROUPON_CREATE => '你参与的{{grouponTitle.DATA}}已开团成功，拼团价为{{grouponPrice.DATA}}元，需{{grouponMemberNum.DATA}}人成团，拼团结束时间为{{grouponEndAt.DATA}}，快复制链接邀请微信好友一起参与吧{{url.DATA}}'],
                'kidList' => ['1', '2', '3', '4', '10'],
                'object' => '购买者',
                'sceneDesc' => '开团成功通知',
                'role' => 'ROLE_USER',
            ...
            self::TEMPLATE_GROUPON_JOIN => [
                ...
                'smsDetail' => [SmsType::GROUPON_JOIN => '你已参与{{grouponTitle.DATA}}团成功，拼团价为{{grouponPrice.DATA}}元，还剩{{grouponRemain.DATA}}人成团，拼团结束时间为{{grouponEndAt.DATA}}，快复制链接邀请微信好友一起参与吧{{url.DATA}}'],
                'kidList' => ['1', '2', '8', '3', '4'],
                'object' => '购买者',
                'sceneDesc' => '参团成功通知',
                'role' => 'ROLE_USER',
