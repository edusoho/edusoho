...
trait ContractDisplayTrait
{
    ...
    {
        $content = $this->getDetailContent($contract['content'], $goodsKey);

        return $this->getHtml($content, $contract['sign'], $this->getCurrentUser(), $contract);
    }
    ...
    protected function getHtml($content, $sign, $user, $contract)
    {
