...
trait ContractDisplayTrait
{
    ...
    private function replaceContentVariable($content, $goodsKey, $contractCode, $sign = [], $user = [])
    {
        ...
        $date = empty($sign['signDate']) ? date('Y年m月d日') : date('Y年m月d日', $sign['signDate']);

        return str_replace(
            ['$name$', '$username$', '$idcard$', '$courseName$', '$contract number$', '$date$', '$order price$'],
            [$truename, $user['nickname'] ?? '', $iDNumber, $product['title'] ?? '', $contractCode, $date, $order['pay_amount'] / 100 ?? ''],
            $content
        );
    }
    ...
    {
//        return $htmlContent = '<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8"><title>合同页面</title></head><body style="padding: 20px 32px 20px 32px; min-width: 311px;"><p style="overflow: hidden; color: #1E2226; text-overflow: ellipsis; font-size: 14px; font-style: normal; font-weight: 500; line-height: 22px; text-align: center;">合作协议书</p><p style="color: #626973; text-align: right; font-size: 12px; font-style: normal; font-weight: 400; line-height: 20px;">合同编号：HT20230712</p><div style="color: #626973; font-size: 12px; font-style: normal; font-weight: 400; line-height: 20px;">fasdfasdfasdfasdfa</div><div><p style="color: #1E2226;  font-size: 18px; font-style: normal; font-weight: 500; line-height: 26px;">甲方：</p><img src="未标题-2.jpg" alt="甲方印章" style="width: 150px; height: 150px; margin-top: 22px;"><div style="margin-top: 22px; display: flex;">甲方公司：<div style="display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;">aaa</div></div><div style="margin-top: 22px; display: flex;">签约日期：<div style="display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;">2024年07月29日</div></div></div><div style="margin-top: 32px;"><p style="color: #1E2226; font-size: 18px; font-style: normal; font-weight: 500; line-height: 26px;">已方：</p><div style="margin-top: 22px; display: flex;">手写签名：<div style="display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;"><img src="未标题-2.jpg" style="height: 35px;"></div></div><div style="margin-top: 22px; display: flex;">签约日期：<div style="display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;">2024年07月29日</div></div></div></body></html>';
        $htmlContentHeader = '<html lang=\'zh-CN\'><head><meta charset=\'UTF-8\'><title>合同页面</title></head><body><p style=\'overflow: hidden; color: #1E2226; text-overflow: ellipsis; font-size: 14px; font-style: normal; font-weight: 500; line-height: 22px; text-align: center;\'>'.$contract['name'].'</p><p style=\'color: #626973; text-align: right; font-size: 12px; font-style: normal; font-weight: 400; line-height: 20px;\'>合同编号：'.$code.'</p><div style=\'color: #626973; font-size: 12px; font-style: normal; font-weight: 400; line-height: 20px;\'>'.$content.'</div><div><p style=\'color: #1E2226; font-size: 18px; font-style: normal; font-weight: 500; line-height: 26px;\'>甲方：</p><img src=\''.AssetHelper::getFurl($contract['seal']).'\' alt=\'甲方印章\' style=\'width: 150px; height: 150px; margin-top: 22px;\'><div style=\'margin-top: 22px; display: flex;\'>签约日期：<div style=\'display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;\'>'.date('Y年m月d日').'</div></div></div><div style=\'margin-top: 32px;\'><p style=\'color: #1E2226; font-size: 18px; font-style: normal; font-weight: 500; line-height: 26px;\'>乙方：</p>';
        $htmlContentOptions = '';
    ...
    private function getHtmlByRecord($content, $signSnapshot, $signDate)
    {
//        return $htmlContent = '<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8"><title>合同页面</title></head><body style="padding: 20px 32px 20px 32px; min-width: 311px;"><p style="overflow: hidden; color: #1E2226; text-overflow: ellipsis; font-size: 14px; font-style: normal; font-weight: 500; line-height: 22px; text-align: center;">合作协议书</p><p style="color: #626973; text-align: right; font-size: 12px; font-style: normal; font-weight: 400; line-height: 20px;">合同编号：HT20230712</p><div style="color: #626973; font-size: 12px; font-style: normal; font-weight: 400; line-height: 20px;">fasdfasdfasdfasdfa</div><div><p style="color: #1E2226; font-size: 18px; font-style: normal; font-weight: 500; line-height: 26px;">甲方：</p><img src="未标题-2.jpg" alt="甲方印章" style="width: 150px; height: 150px; margin-top: 22px;"><div style="margin-top: 22px; display: flex;">甲方公司：<div style="display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;">aaa</div></div><div style="margin-top: 22px; display: flex;">签约日期：<div style="display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;">2024年07月29日</div></div></div><div style="margin-top: 32px;"><p style="color: #1E2226; font-size: 18px; font-style: normal; font-weight: 500; line-height: 26px;">已方：</p><div style="margin-top: 22px; display: flex;">手写签名：<div style="display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;"><img src="未标题-2.jpg" style="height: 35px;"></div></div><div style="margin-top: 22px; display: flex;">签约日期：<div style="display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;">2024年07月29日</div></div></div></body></html>';
        $htmlContentHeader = '<html lang=\'zh-CN\'><head><meta charset=\'UTF-8\'><title>合同页面</title></head><body><p style=\'overflow: hidden; color: #1E2226; text-overflow: ellipsis; font-size: 14px; font-style: normal; font-weight: 500; line-height: 22px; text-align: center;\'>'.$signSnapshot['contract']['name'].'</p><p style=\'color: #626973; text-align: right; font-size: 12px; font-style: normal; font-weight: 400; line-height: 20px;\'>合同编号：'.$signSnapshot['contractCode'].'</p><div style=\'color: #626973; font-size: 12px; font-style: normal; font-weight: 400; line-height: 20px;\'>'.$content.'</div><div><p style=\'color: #1E2226; font-size: 18px; font-style: normal; font-weight: 500; line-height: 26px;np\'>甲方：</p><img src=\''.AssetHelper::getFurl($signSnapshot['contract']['seal']).'\' alt=\'甲方印章\' style=\'width: 150px; height: 150px; margin-top: 22px;\'><div style=\'margin-top: 22px; display: flex;\'>签约日期：<div style=\'display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;\'>'.date('Y年m月d日', $signDate).'</div></div></div><div style=\'margin-top: 32px;\'><p style=\'color: #1E2226; font-size: 18px; font-style: normal; font-weight: 500; line-height: 26px;\'>乙方：</p>';
        $htmlContentOptions = '';
        $htmlContentFoot = '<div style=\'margin-top: 22px; display: flex;\'>签约日期：<div style=\'display: flex; align-items: center; gap: 10px; flex: 1 0 0; border-bottom: 0.5px solid #919399; width: 241px;\'>'.date('Y年m月d日', $signDate).'</div></div></div></body></html>';
