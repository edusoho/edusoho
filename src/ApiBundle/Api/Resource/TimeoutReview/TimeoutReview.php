...
class TimeoutReview extends AbstractResource
{
    ...
    {
        $assessments = $this->getAssessmentService()->findAssessmentsByIds(array_column($answerRecords, 'assessment_id'));
        ...
        foreach ($answerRecords as &$answerRecord) {
            ...
            $answerRecord['assessment'] = $assessments[$answerRecord['assessment_id']] ?? [];
            $answerRecord['multiClass'] = $multiClasses[$answerRecord['activity']['fromCourseId']] ?? [];
            $answerRecord['userInfo'] = $users[$answerRecord['user_id']] ?? [];
            ...
            $answerRecord['assistantInfo'] = $users[$assistantId] ?? [];
        }
