...
class CourseTaskFilter extends Filter
{
    protected $publicFields = array(
        'activity', 'id', 'title', 'isFree', 'isOptional', 'startTime', 'endTime', 'status', 'length', 'mode', 'type', 'mediaSource', 'lock', 'number', 'seq', 'result', 'subtitlesUrls', 'categoryId', 'enable_facein', 'courseUrl', 'isLiving'
    );
