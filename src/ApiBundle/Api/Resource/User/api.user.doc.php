 ...
 *             @OA\Property(property="currentIp",description="",type="string"),
 *             @OA\Property(property="gender",description=""),
 *             @OA\Property(property="iam",description=""),
 *             @OA\Property(property="city",description="",type="string"),
 *             @OA\Property(property="qq",description="",type="string"),
 *             @OA\Property(property="signature",description=""),
 *             @OA\Property(property="company",description="",type="string"),
 *             @OA\Property(property="job",description="",type="string"),
 *             @OA\Property(property="school",description="",type="string"),
 *             @OA\Property(property="class",description=""),
 *             @OA\Property(property="weibo",description="",type="string"),
 *             @OA\Property(property="weixin",description="",type="string"),
