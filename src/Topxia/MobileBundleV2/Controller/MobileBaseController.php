...
class MobileBaseController extends BaseController
{
    ...
    public function filterCourses($courses)
    {
        ...
        return array_map(function($course) use ($self, $container, $teachers, $coinSetting) {
            $course['smallPicture'] = $container->get('topxia.twig.web_extension')->getFpath($course['smallPicture'], 'course.png', true);
            $course['middlePicture'] = $container->get('topxia.twig.web_extension')->getFpath($course['middlePicture'], 'course.png', true);
            $course['largePicture'] = $container->get('topxia.twig.web_extension')->getFpath($course['largePicture'], 'course.png', true);
