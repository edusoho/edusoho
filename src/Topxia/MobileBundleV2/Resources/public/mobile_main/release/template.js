angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/view/alipay_modal.html',
  ...
  $templateCache.put('/view/category.html',
  ...
  $templateCache.put('/view/category_tree.html',
  ...
  $templateCache.put('/view/course.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">{{ course.title }}</h3><div class=\"bar-tool\" ng-show=\"member\"><a class=\"ui-btn btn-outline iconfont icon-tixing\" href=\"#/coursenotice/{{ course.id }}\"></a> <a class=\"ui-btn btn-outline iconfont icon-shezhi\" href=\"#/coursesetting/{{ course.id }}/true\"></a></div></div></div><div ng-include=\"courseView\"></div>"
  );


  $templateCache.put('/view/course_detail.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">课程概览</h3></div></div><div class=\"top-header ui-course ui-course-detail\"><section class=\"ui-panel ui-panel-card ui-border-t\"><h2 class=\"title-body\"><span class=\"title\">课程简介</span></h2><div class=\"ui-panel-content\" ng-bind-html=\"course.about\"></div></section><section class=\"ui-panel ui-panel-card ui-border-t\"><h2 class=\"title-body\"><span class=\"title\">课程目标</span></h2><div class=\"ui-panel-content\"><li ng-repeat=\"goal in course.goals\">{{ goal }}</li></div></section><section class=\"ui-panel ui-panel-card ui-border-t\"><h2 class=\"title-body\"><span class=\"title\">适合人群</span></h2><div class=\"ui-panel-content\"><li ng-repeat=\"audience in course.audiences\">{{ audience }}</li></div></section></div>"
  );


  $templateCache.put('/view/course_learn.html',
    "<div class=\"ui-course top-header\"><div class=\"course-head-body\"><div class=\"course-head\"><img class=\"full-image\" ng-src=\"{{ course.largePicture }}\" img-error=\"course\"><p class=\"mask\"><a class=\"learned\">已完成{{ learnProgress }}</a></p><div class=\"course-progress\"><span ng-style=\"{ width : learnProgress }\"></span></div></div></div><ul class=\"ui-list ui-list-lesson ui-border-b\"><li class=\"{{ lesson.type }}\" ng-repeat=\"lesson in lessons\" ng-class=\"lesson.id == lastLearnStatusIndex ? 'list-green' : '' \" ng-click=\"learnLesson(lesson)\"><div class=\"lesson-status\" ng-if=\"lesson.type !='chapter' && lesson.type !='unit' \"><i class=\"iconfont\" ng-class=\"learnStatuses[lesson.id] == 'finished' ? 'icon-xiazaiwancheng' : 'icon-jikediancanicon11' \"></i></div><div class=\"ui-list-info ui-border-t\" ng-class=\"lesson.type\"><h4 class=\"ui-nowrap\">{{ lesson | formatChapterNumber }} {{ lesson.title }}</h4></div><div class=\"ui-list-action lesson-time\">{{ lesson.length }}</div></li><list-empty-view class=\"lesson-empty\" data=\"lessons\" title=\"暂无课时\"></list-empty-view></ul></div>"
  );


  $templateCache.put('/view/course_learn_tab.html',
    "<div class=\"course-tab-content learn\"><ion-pane class=\"learn\"><div class=\"list lesson-list\"><list-empty-view class=\"lesson-empty\" data=\"lessons\" title=\"暂无课时\"></list-empty-view><a class=\"item {{ lesson.type }}\" ng-class=\"learnStatuses[lesson.id] == 'finished' ? 'activated' : '' \" ng-repeat=\"lesson in lessons\"><span class=\"lesson-status\" ng-if=\"lesson.type !='chapter' && lesson.type !='unit' \"><i class=\"iconfont icon-roundcheck\"></i></span> <span class=\"lesson-body\"><span class=\"lesson-title\">{{ lesson | formatChapterNumber }} {{ lesson.title }}</span> <span class=\"lesson-length\">{{ lesson.length }}</span></span></a></div><ion-infinite-scroll ng-if=\"! lessons\" class=\"active\" distance=\"1%\"></ion-infinite-scroll></ion-pane></div>"
  );


  $templateCache.put('/view/course_list.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">分类搜索</h3></div></div><div class=\"ui-tab tab-top\" ui-tab select=\"empty\"><ul class=\"ui-tab-nav ui-border-b\"><li><span class=\"line\">{{ categoryTab.category }}<i class=\"iconfont icon-keyboardarrowdown\"></i></span></li><li><span class=\"line\">{{ categoryTab.type }}<i class=\"iconfont icon-keyboardarrowdown\"></i></span></li><li><span class=\"line\">{{ categoryTab.sort }}<i class=\"iconfont icon-keyboardarrowdown\"></i></span></li></ul><ul class=\"ui-tab-content tab-display top-tab-header\" style=\"position: fixed\"><li modal><div class=\"content category-card\"><category-tree ng-if=\"categoryTree\" data=\"categoryTree\" listener=\"categorySelectedListener\"></category-tree></div><div class=\"backdrop-bg\"></div></li><li modal><div class=\"content\"><ul class=\"ui-list ui-list-text ui-list-cover ui-list-active\"><li class=\"ui-border-b\" ng-click=\"selectType(item)\" ng-repeat=\"item in courseListTypes\">{{ item.name }}</li></ul></div><div class=\"backdrop-bg\"></div></li><li modal><div class=\"content\"><ul class=\"ui-list ui-list-text ui-list-cover ui-list-active\"><li class=\"ui-border-b\" ng-click=\"selectSort(item)\" ng-repeat=\"item in courseListSorts\">{{ item.name }}</li></ul></div><div class=\"backdrop-bg\"></div></li></ul><div class=\"ui-scroller course-card\" ui-scroll data=\"courses\" on-infinite=\"loadMore()\"><ul class=\"ui-list ui-border-tb\"><li class=\"ui-border-t\" ng-repeat=\"course in courses\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture }} \" img-error=\"course\"></div><div class=\"ui-list-info\"><h2 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h2><p class=\"bottom price-body\"><span class=\"origin-price\">{{ course.price | formatPrice }} <s class=\"discount-color\" ng-if=\"course.discountId > 0\">{{ course.originPrice | formatPrice }}</s></span> <span class=\"right\"><i class=\"iconfont icon-person\"></i> {{ course.studentNum }}人在学</span></p></div></li></ul><list-empty-view data=\"courses\" title=\"暂时没有课程\"></list-empty-view><div class=\"ui-loading-wrap\" ng-show=\"canLoad\"><p>正在加载中...</p><i class=\"ui-loading\"></i></div></div></div>"
  );


  $templateCache.put('/view/course_no_learn.html',
    "<div class=\"ui-course top-header\" style=\"padding-bottom: 58px\"><div class=\"course-head-body\"><div class=\"course-head\"><img class=\"full-image\" ng-src=\"{{ course.largePicture }}\" img-error=\"course\"><p class=\"mask\"><a class=\"rating-body\"><span><i class=\"iconfont\" ng-class=\"course.rating > i ? 'icon-favorfill' : 'icon-favor' \" ng-repeat=\"i in ratingArray\"></i></span> <span class=\"rating\">{{ course.rating }}</span></a> <a class=\"right\">{{ course.studentNum }} 人在学</a></p></div><div class=\"item-body\"><p class=\"course-title\">{{ course.title }}</p><p class=\"course-price\"><span class=\"price-block\">{{ course.price | formatPrice }}</span> <span ng-if=\"discount\" class=\"discount-type discount\">{{ discount.type | coverDiscount : course.discount }}</span> <span ng-if=\"discount\" class=\"discount-type type\">{{ discount.name }}</span></p><p ng-if=\"discount\" class=\"discount-body\"><s class=\"price-block\">{{ course.originPrice | formatPrice }}</s> <span>倒计时:{{ discount.endTime | coverDiscountTime }}</span></p></div></div><div class=\"ui-tab tab-top\" ui-tab><ul class=\"ui-tab-nav ui-border-tb\"><li><span class=\"line\">课程标题</span></li><li><span>课程详情</span></li></ul><ul class=\"ui-tab-content tab-display\"><li><ul class=\"ui-list ui-list-lesson ui-border-b\"><li ng-class=\"lesson.type\" ng-repeat=\"lesson in lessons\" ng-click=\"learnLesson(lesson)\"><div class=\"lesson-status\" ng-if=\"lesson.type !='chapter' && lesson.type !='unit' \"><i class=\"iconfont icon-jikediancanicon11\"></i></div><div class=\"ui-list-info ui-border-t\" ng-class=\"lesson.type\"><h4 class=\"ui-nowrap\">{{ lesson | formatChapterNumber }} {{ lesson.title }}</h4></div><div class=\"ui-list-action lesson-time\">{{ lesson.length }}</div></li><list-empty-view class=\"lesson-empty\" data=\"lessons\" title=\"暂无课时\"></list-empty-view></ul></li><li><section class=\"ui-panel ui-panel-card ui-border-t\"><h2 class=\"title-body\"><span class=\"title\">课程概览</span> <a class=\"title-tips\" href=\"#/coursedetail/{{ course.id }}\"><i class=\"iconfont icon-gengduo\"></i></a></h2><div class=\"ui-panel-content\" ng-bind-html=\"course.about\"></div></section><section class=\"ui-panel ui-panel-card ui-border-t\"><h2 class=\"title-body\"><span class=\"title\">课程教师 ({{ course.teachers.length }})</span> <a class=\"title-tips\" href=\"#/teacherlist/{{ course.id }}\"><i class=\"iconfont icon-gengduo\"></i></a></h2><div class=\"ui-panel-content\"><ul class=\"ui-list\"><li class=\"ui-border-t\" ng-if=\"course.teachers[0]\"><div class=\"ui-avatar-s\" ui-sref=\"userInfo({ userId : course.teachers[0].id })\"><img ng-src=\"{{ course.teachers[0].avatar | coverAvatar }}\"></div><div class=\"ui-list-info\"><h4 class=\"ui-nowrap\">{{ course.teachers[0].nickname }} <span class=\"teacher-label\">教师</span></h4><p class=\"ui-nowrap\">{{ course.teachers[0].title }}</p></div></li><li ng-if=\"! course.teachers[0]\"><p>该课程暂无教师</p></li></ul></div></section><section class=\"ui-panel ui-panel-card ui-border-t\"><h2 class=\"title-body\"><span class=\"title\">课程评价 ({{ reviews.length }})</span> <a class=\"title-tips\" href=\"#/coursereview/{{ course.id }}\"><i class=\"iconfont icon-gengduo\"></i></a></h2><div class=\"ui-panel-content ui-review\"><ul class=\"ui-list\"><li class=\"ui-border-t\" ng-if=\"reviews[0]\"><div class=\"ui-avatar-s\" ui-sref=\"userInfo({ userId : reviews[0].user.id })\"><img ng-src=\"{{ reviews[0].user.mediumAvatar | coverAvatar }}\"></div><div class=\"ui-list-info\"><h4 class=\"ui-nowrap ui-review-header\">{{ reviews[0].user.nickname }} <span class=\"ui-review-rating\"><i class=\"iconfont\" ng-class=\"reviews[0].rating > i ? 'icon-favorfill' : 'icon-favor' \" ng-repeat=\"i in ratingArray\"></i></span></h4><p class=\"ui-nowrap\">{{ reviews[0].content }}</p></div></li><li ng-if=\"! reviews[0]\"><p>该课程暂无评价</p></li></ul></div></section></li></ul></div></div><div class=\"ui-course-tool\" style=\"box-shadow: 0 0 2px rgba(0, 0, 0, 0.5)\"><button class=\"ui-btn btn-outline btn-col-15 iconfont icon-fenxiang\" ng-click=\"shardCourse()\"></button> <button ng-click=\"favoriteCourse()\" ng-class=\"isFavorited ? 'course-favorited' : '' \" class=\"ui-btn btn-outline btn-col-15 iconfont icon-shoucang1\"></button> <button class=\"ui-btn btn-green\" ng-class=\"course.vipLevelId <= 0 ? 'btn-col-60' : 'btn-col-25' \" ng-click=\"joinCourse()\">立即加入</button> <button class=\"ui-btn btn-yellow btn-col-35 ui-nowrap\" ng-click=\"joinCourse()\" ng-if=\"course.vipLevelId > 0 \">{{ vipLevels[course.vipLevelId - 1].name }}会员免费学</button></div>"
  );


  $templateCache.put('/view/course_nolearn_tab.html',
    "<div class=\"course-tab-content\"><ion-tabs class=\"tabs-green tabs-top tabs-background-positive tabs-color-light tabs-icon-left course-tab\" delegate-handle=\"tabHandle\"><ion-tab class=\"line\" title=\"课时\" on-select=\"onTabSelected()\"></ion-tab><ion-tab title=\"课程详情\" on-select=\"onTabSelected()\"></ion-tab></ion-tabs><ion-pane ng-show=\"selectedIndex == 0\"><div class=\"list lesson-list\"><list-empty-view class=\"lesson-empty\" data=\"lessons\" title=\"暂无课时\"></list-empty-view><a class=\"item\" ng-class=\"lesson.type\" ng-repeat=\"lesson in lessons\"><span class=\"lesson-status\" ng-if=\"lesson.type !='chapter' && lesson.type !='unit' \"><i class=\"iconfont icon-roundcheck\"></i></span> <span class=\"lesson-body\"><span class=\"lesson-title\">{{ lesson | formatChapterNumber }} {{ lesson.title }}</span> <span class=\"lesson-length\">{{ lesson.length }}</span></span></a></div><ion-infinite-scroll ng-if=\"! lessons\" class=\"active\" distance=\"1%\"></ion-infinite-scroll></ion-pane><ion-pane ng-show=\"selectedIndex == 1\"><div class=\"body\"><div class=\"card\"><span class=\"card-head\"><h5>课程概览</h5><a class=\"button button-icon iconfont icon-menu\" href=\"#/coursedetail/{{ course.id }}\"></a></span><div class=\"item item-text-wrap\" ng-bind-html=\"course.about\"></div></div><div class=\"card\"><span class=\"card-head\"><h5>课程教师 ({{ course.teachers.length }})</h5><a class=\"button button-icon iconfont icon-menu\" href=\"#/teacherlist/{{ course.id }}\"></a></span><div class=\"list\"><a class=\"item item-avatar\" ng-if=\"course.teachers[0]\"><img ng-src=\"{{ course.teachers[0].avatar | coverAvatar }}\"><h3>{{ course.teachers[0].nickname }} <span class=\"teacher-label\">教师</span></h3><p>{{ course.teachers[0].title }}</p></a> <a class=\"item\" ng-if=\"! course.teachers[0]\"><p>该课程暂无教师</p></a></div></div><div class=\"card\"><span class=\"card-head\"><h5>课程评价 ({{ reviews.length }})</h5><a class=\"button button-icon iconfont icon-menu\"></a></span><div class=\"list\"><a ng-if=\"reviews\" class=\"item item-avatar\"><img ng-src=\"{{ reviews[0].user.mediumAvatar | coverAvatar }}\"><div class=\"review-rating\"><h3>{{ reviews[0].user.nickname }}</h3><span><i class=\"iconfont icon-favorfill\" ng-class=\"reviews[0].rating > i ? 'course-rating' : '---' \" ng-repeat=\"i in ratingArray\"></i></span></div><p>{{ reviews[0].content }}</p></a> <a class=\"item\" ng-if=\"! reviews\"><p>该课程暂无评价</p></a></div></div></div></ion-pane></div>"
  );


  $templateCache.put('/view/course_notice.html',
  ...
  $templateCache.put('/view/course_pay.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">确认订单</h3></div></div><div class=\"top-header ui-course-pay\"><div class=\"ui-form ui-border-t\"><div class=\"ui-form-item ui-border-b ui-list-divider\">确认个人信息</div><div class=\"ui-form-item ui-border-b\"><label>姓名</label><input type=\"text\" placeholder=\"姓名\" ng-model=\"data.userProfile.truename\"> <a class=\"ui-icon-close\" ng-show=\"data.userProfile.truename.length > 0\" ng-click=\"data.userProfile.truename = '' \"></a></div><div class=\"ui-form-item ui-border-b\"><label>手机</label><input type=\"text\" placeholder=\"手机\" ng-model=\"data.userProfile.mobile\"> <a class=\"ui-icon-close\" ng-show=\"data.userProfile.mobile.length > 0\" ng-click=\"data.userProfile.mobile = '' \"></a></div></div><ul class=\"ui-list ui-list-text ui-border-b ui-paycard\"><li class=\"ui-border-t ui-list-divider\">购买课程</li><li class=\"ui-border-t\"><div class=\"ui-list-img\"><img ng-src=\"{{ data.course.middlePicture }}\"></div><div class=\"ui-list-info\"><h4 class=\"ui-nowrap\">{{ data.course.title }}</h4><p class=\"pay-price\">{{ data.course.price | formatPrice }}</p></div></li></ul><ul class=\"ui-list ui-list-link ui-list-text ui-border-b\" ng-if=\"data.isInstalledCoupon\"><li class=\"ui-border-t ui-list-divider\">优惠信息</li><li class=\"ui-border-t\"><h4 class=\"ui-nowrap\">优惠<span class=\"pay-price\">{{ coupon.decreaseAmount }}</span></h4></li></ul><div class=\"ui-btn-wrap\" style=\"background: #f0f0f0\"><div class=\"pay-body\">需支付:<p class=\"pay-price\">{{ data.course.price - coupon.decreaseAmount | formatPrice }}</p></div><button class=\"ui-btn-lg btn-yellow\" ng-click=\"pay()\">去支付</button></div></div>"
  );


  $templateCache.put('/view/course_review.html',
  ...
  $templateCache.put('/view/course_setting.html',
  ...
  $templateCache.put('/view/courselist_modal.html',
  ...
  $templateCache.put('/view/courselist_sort.html',
  ...
  $templateCache.put('/view/courselist_type.html',
  ...
  $templateCache.put('/view/found.html',
  ...
  $templateCache.put('/view/found_classroom.html',
  ...
  $templateCache.put('/view/main_content.html',
  ...
  $templateCache.put('/view/menu_view.html',
  ...
  $templateCache.put('/view/message.html',
    "<ion-header-bar class=\"bar-positive\"><h1 class=\"title\">动态</h1></ion-header-bar><ion-view><ion-content class=\"padding\">dongtai</ion-content></ion-view>"
  );


  $templateCache.put('/view/myfavorite.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">我的收藏</h3></div></div><div class=\"ui-tab tab-top\" ui-tab><ul class=\"ui-tab-nav ui-border-b\"><li><span class=\"line\">课程</span></li><li><span>直播课</span></li></ul><ul class=\"ui-tab-content tab-display ui-course-learn\"><li><div class=\"ui-scroller course-card\"><ul class=\"ui-list ui-border-tb\"><li class=\"ui-list-avatar\" ng-repeat=\"course in data.course.data\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture | coverPic }}\" img-error=\"course\"></div><div class=\"ui-list-info ui-border-t\"><h2 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h2><p class=\"bottom price-body\"><span class=\"origin-price\">{{ course.price | formatPrice }} <s class=\"discount-color\" ng-if=\"course.discountId > 0\">{{ course.originPrice | formatPrice }}</s></span></p></div></li></ul><list-empty-view data=\"data.course.data\" title=\"暂时没有收藏课程\"></list-empty-view></div></li><li><div class=\"ui-scroller course-card\"><ul class=\"ui-list ui-border-tb\"><li class=\"ui-border-t ui-list-avatar\" ng-repeat=\"course in data.live.data\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture | coverPic }}\" img-error=\"course\"></div><div class=\"ui-list-info\"><h2 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h2><p class=\"bottom price-body\"><span class=\"origin-price\">{{ course.price | formatPrice }} <s class=\"discount-color\" ng-if=\"course.discountId > 0\">{{ course.originPrice | formatPrice }}</s></span></p></div></li></ul><list-empty-view data=\"data.live.data\" title=\"暂时没有收藏直播课程\"></list-empty-view></div></li></ul></div>"
  );


  $templateCache.put('/view/myfavorite_course.html',
    "<ion-view><ion-content class=\"padding content-padding\"><div class=\"course-card\"><div class=\"list\"><a class=\"item item-thumbnail-left\" href=\"#\" ng-repeat=\"course in data.course.data\"><img src=\"{{ course.middlePicture | coverPic}}\"><h2>{{ course.title }}</h2><p class=\"bottom\"><span><i class=\"iconfont icon-person\"></i> {{ course.studentNum }}</span> <span class=\"price light-color\">...</span></p></a></div></div><ion-infinite-scroll ng-if=\"canLoadMore('course')\" on-infinite=\"loadMore('course')\" distance=\"1%\"></ion-infinite-scroll></ion-content></ion-view>"
  );


  $templateCache.put('/view/myfavorite_live.html',
    "<ion-view><ion-content class=\"padding content-padding\"><div class=\"course-card\"><div class=\"list\"><a class=\"item item-thumbnail-left\" href=\"#\" ng-repeat=\"course in data.course.data\"><img src=\"{{ course.middlePicture | coverPic}}\"><h2>{{ course.title }}</h2><p class=\"bottom\"><span><i class=\"iconfont icon-person\"></i> {{ course.studentNum | blockStr }}</span> <span class=\"price light-color\">...</span></p></a></div></div><ion-infinite-scroll ng-if=\"canLoadMore('live')\" on-infinite=\"loadMore('live')\" distance=\"1%\"></ion-infinite-scroll></ion-content></ion-view>"
  );


  $templateCache.put('/view/mygroup.html',
  ...
  $templateCache.put('/view/mygroup_note.html',
    "<div ng-controller=\"MyGroupNoteController\"><div class=\"ui-scroller\" ui-scroll data=\"data\" on-infinite=\"loadMore()\"><ul class=\"ui-list ui-list-card ui-question\"><li class=\"ui-border-t\" ng-repeat=\"note in data\" ui-sref=\"note({ noteId : note.id })\"><div class=\"ui-list-info\"><h4 class=\"padding\">{{ note.title }}</h4><p class=\"padding\">{{ note.content | blockStr : 50 }}</p><ul class=\"ui-grid-halve padding\"><li>{{ note.lessonTitle }}</li><li>{{ question.updatedTime | coverLearnTime }}</li></ul></div></li></ul><list-empty-view data=\"data\" title=\"暂时没有笔记\"></list-empty-view><div class=\"ui-loading-wrap\" ng-show=\"canLoad\"><p>正在加载中...</p><i class=\"ui-loading\"></i></div></div></div>"
  );


  $templateCache.put('/view/mygroup_question.html',
    "<div ng-controller=\"MyGroupQuestionController\"><div class=\"ui-scroller\" ui-scroll data=\"courses\" on-infinite=\"loadMore()\"><ul class=\"ui-list ui-list-card ui-question\"><li class=\"ui-border-t\" ng-repeat=\"question in data\" ui-sref=\"question({ courseId : question.courseId, threadId : question.id })\"><div class=\"ui-list-info\"><h4 class=\"padding\">{{ question.title }}</h4><p class=\"padding\">{{ question.latestPostContent | blockStr : 50 }}</p><ul class=\"ui-grid-trisect padding\"><li>{{ question.courseTitle }}</li><li>{{ question.latestPostTime | coverLearnTime }}</li><li>{{ question.postNum }}个回复</li></ul></div></li></ul><list-empty-view data=\"courses\" title=\"暂时没有课程\"></list-empty-view><div class=\"ui-loading-wrap\" ng-show=\"canLoad\"><p>正在加载中...</p><i class=\"ui-loading\"></i></div></div></div>"
  );


  $templateCache.put('/view/mygroup_thread.html',
    "<div ng-controller=\"MyGroupThreadController\"><div class=\"ui-scroller\" ui-scroll data=\"data\" on-infinite=\"loadMore()\"><ul class=\"ui-list ui-list-card ui-question\"><li class=\"ui-border-t\" ng-repeat=\"question in data\" ui-sref=\"question({ courseId : question.courseId, threadId : question.id })\"><div class=\"ui-list-info\"><h4 class=\"padding\">{{ question.title }}</h4><p class=\"padding\">{{ question.latestPostContent | blockStr : 50 }}</p><ul class=\"ui-grid-trisect padding\"><li>{{ question.courseTitle }}</li><li>{{ question.latestPostTime | coverLearnTime }}</li><li>{{ question.postNum }}个回复</li></ul></div></li></ul><list-empty-view data=\"data\" title=\"暂时没有课程\"></list-empty-view><div class=\"ui-loading-wrap\" ng-show=\"canLoad\"><p>正在加载中...</p><i class=\"ui-loading\"></i></div></div></div>"
  );


  $templateCache.put('/view/myinfo.html',
  ...
  $templateCache.put('/view/mylearn.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">我的学习</h3></div></div><div class=\"ui-tab tab-top\" ui-tab><ul class=\"ui-tab-nav ui-border-b\"><li><span class=\"line\">课程</span></li><li><span>直播课</span></li></ul><ul class=\"ui-tab-content tab-display ui-course-learn\"><li><div class=\"ui-scroller\"><ul class=\"ui-list ui-border-tb\"><li class=\"ui-border-t ui-list-avatar\" ng-repeat=\"course in course.data\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture | coverPic }}\" img-error=\"course\"></div><div class=\"ui-list-info\"><h4 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h4><p><span>上次学习时间:{{ course.startTime | coverLearnTime }}</span><div class=\"ui-progress\"><span ng-style=\"course | coverLearnProsser\"></span></div></p></div></li></ul><list-empty-view data=\"course.data\" title=\"暂时没有课程\"></list-empty-view></div></li><li><div class=\"ui-scroller\"><ul class=\"ui-list ui-border-tb\"><li class=\"ui-border-t ui-list-avatar\" ng-repeat=\"course in live.data\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture | coverPic }}\" img-error=\"course\"></div><div class=\"ui-list-info\"><h4 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h4><p><span>上次学习时间:{{ course.startTime | coverLearnTime }}</span><div class=\"ui-progress\"><span ng-style=\"course | coverLearnProsser\"></span></div></p></div></li></ul><list-empty-view data=\"live.data\" title=\"暂时没有直播课程\"></list-empty-view></div></li></ul></div>"
  );


  $templateCache.put('/view/mylearn_classroom.html',
  ...
  $templateCache.put('/view/mylearn_course.html',
  ...
  $templateCache.put('/view/mylearn_live.html',
  ...
  $templateCache.put('/view/note.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">笔记详情</h3></div></div><div class=\"top-header ui-question\"><section class=\"ui-panel ui-panel-card ui-question-panel\"><h2 class=\"ui-arrowlink\">{{ note.courseTitle }}</h2><ul class=\"ui-list ui-list-text ui-border-t\"><li><h4>{{ note.title }}</h4></li><li><div class=\"ui-list-info\"><div class=\"ui-question-panel content\" ng-bind-html=\"note.content\"></div></div></li></ul></section></div>"
  );


  $templateCache.put('/view/question.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">问答详情</h3></div></div><div class=\"top-header ui-question\"><section class=\"ui-panel ui-panel-card ui-question-panel\"><h2 class=\"ui-arrowlink\">{{ thread.courseTitle }}</h2><ul class=\"ui-list ui-list-text ui-border-tb\"><li><h4>{{ thread.title }}</h4></li><li><div class=\"ui-avatar\"><img ng-src=\"{{ thread.user.mediumAvatar }}\"></div><div class=\"ui-list-info\"><h4 class=\"ui-nowrap\">{{ thread.user.nickname }}</h4><p class=\"ui-nowrap\">{{ thread.latestPostTime | coverLearnTime }}</p></div></li><li><div class=\"ui-list-info\"><div class=\"ui-question-panel content\" ng-bind-html=\"thread.content\"></div><div class=\"ui-question-panel tool-bar\"><span><i class=\"iconfont icon-visibility\"></i> {{ thread.hitNum }}</span> <span><i class=\"iconfont icon-modecomment\"></i> {{ thread.postNum }}</span></div></div></li></ul></section><section class=\"ui-panel ui-panel-card ui-question-panel\"><h2><span>教师回答({{ teacherPosts.length }})</span></h2><ul class=\"ui-list ui-list-text\" ng-repeat=\"teacherPost in teacherPosts\"><li><div class=\"ui-avatar-s\"><img ng-src=\"{{ teacherPost.user.mediumAvatar}}\"></div><div class=\"ui-list-info\"><h4 class=\"ui-nowrap\">{{ teacherPost.user.nickname }}</h4><p class=\"ui-nowrap\">{{ teacherPost.latestPostTime | coverLearnTime }}</p></div></li><li class=\"ui-border-b\"><div class=\"ui-list-info ui-question-panel content\" ng-bind-html=\"teacherPost.content\"></div></li></ul></section><section class=\"ui-panel ui-panel-card ui-question-panel ui-border-t\" style=\"margin-top : -1px\"><h2><span>所有回答({{ threadPosts.length }})</span></h2><ul class=\"ui-list ui-list-text\" ng-repeat=\"threadPost in threadPosts\"><li><div class=\"ui-avatar-s\"><img ng-src=\"{{ threadPost.user.mediumAvatar}}\"></div><div class=\"ui-list-info\"><h4 class=\"ui-nowrap\">{{ threadPost.user.nickname }}</h4><p class=\"ui-nowrap\">{{ threadPost.latestPostTime | coverLearnTime }}</p></div></li><li class=\"ui-border-b\"><div class=\"ui-list-info ui-question-panel content\" ng-bind-html=\"threadPost.content\"></div></li></ul></section></div><!-- \n" +
  ...
  $templateCache.put('/view/regist.html',
  ...
  $templateCache.put('/view/regist_email.html',
  ...
  $templateCache.put('/view/regist_phone.html',
  ...
  $templateCache.put('/view/setting.html',
  ...
  $templateCache.put('/view/teacher_list.html',
  ...
  $templateCache.put('/view/user_info.html',
  ...
  $templateCache.put('/view/vip_list.html',
  ...
  $templateCache.put('/view/vip_pay.html',
