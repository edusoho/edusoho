angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/bundles/topxiamobilebundlev2/main/view/myfavorite_course.html',
    "<div class=\"ui-scroller course-card\" ng-controller=\"MyFavoriteCourseController\"><ul class=\"ui-list\"><li class=\"ui-list-avatar ui-border-t\" ng-repeat=\"course in data.course.data\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture | coverPic }}\" img-error=\"course\"></div><div class=\"ui-list-info\"><h2 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h2><p class=\"bottom price-body\"><span class=\"origin-price\">{{ course.price | formatPrice }} <s class=\"discount-color\" ng-if=\"course.discountId > 0\">{{ course.originPrice | formatPrice }}</s></span></p></div></li></ul><list-empty-view data=\"data.course.data\" title=\"暂时没有收藏课程\"></list-empty-view></div>"
  );


  $templateCache.put('/bundles/topxiamobilebundlev2/main/view/myfavorite_live.html',
    "<div class=\"ui-scroller course-card\" ng-controller=\"MyFavoriteLiveController\"><ul class=\"ui-list\"><li class=\"ui-border-t ui-list-avatar\" ng-repeat=\"course in data.live.data\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture | coverPic }}\" img-error=\"course\"></div><div class=\"ui-list-info\"><h2 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h2><p class=\"bottom price-body\"><span class=\"origin-price\">{{ course.price | formatPrice }} <s class=\"discount-color\" ng-if=\"course.discountId > 0\">{{ course.originPrice | formatPrice }}</s></span></p></div></li></ul><list-empty-view data=\"data.live.data\" title=\"暂时没有收藏直播课程\"></list-empty-view></div>"
  );
  ...
  $templateCache.put('/bundles/topxiamobilebundlev2/main/view/mylearn.html',
    "<div class=\"ui-bar\" ui-bar><div class=\"ui-bar-bg\"><button class=\"ui-btn btn-outline iconfont icon-fanhui\" back=\"go\"></button><h3 class=\"title\">我的学习</h3></div></div><div class=\"ui-tab tab-top\" ui-tab><ul class=\"ui-tab-nav ui-border-b\"><li><span class=\"line\">课程</span></li><li><span>直播课</span></li></ul><ul class=\"ui-tab-content tab-display ui-course-learn\"><li><div class=\"ui-scroller course-card\" ui-scroll data=\"course.data\" on-infinite=\"loadMore('course')\"><ul class=\"ui-list ui-border-tb\"><li class=\"ui-border-t ui-list-avatar\" ng-repeat=\"course in course.data\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture | coverPic }}\" img-error=\"course\"></div><div class=\"ui-list-info\"><h2 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h2><p><span>上次学习时间:{{ course.startTime | coverLearnTime }}</span><div class=\"ui-progress\"><span ng-style=\"course | coverLearnProsser\"></span></div></p></div></li></ul><list-empty-view data=\"course.data\" title=\"暂时没有课程\"></list-empty-view><div class=\"ui-loading-wrap\" ng-show=\"canLoadMore('course')\"><p>正在加载中...</p><i class=\"ui-loading\"></i></div></div></li><li><div class=\"ui-scroller course-card\" ui-scroll data=\"live.data\" on-infinite=\"loadMore('live')\"><ul class=\"ui-list ui-border-tb\"><li class=\"ui-border-t ui-list-avatar\" ng-repeat=\"course in live.data\" ui-sref=\"course({ courseId : course.id })\"><div class=\"ui-list-img\"><img ng-src=\"{{ course.middlePicture | coverPic }}\" img-error=\"course\"></div><div class=\"ui-list-info\"><h2 class=\"ui-nowrap ui-list-title\">{{ course.title }}</h2><p><span>上次学习时间:{{ course.startTime | coverLearnTime }}</span><div class=\"ui-progress\"><span ng-style=\"course | coverLearnProsser\"></span></div></p></div></li></ul><list-empty-view data=\"live.data\" title=\"暂时没有直播课程\"></list-empty-view><div class=\"ui-loading-wrap\" ng-show=\"canLoadMore('live')\"><p>正在加载中...</p><i class=\"ui-loading\"></i></div></div></li></ul></div>"
  );
