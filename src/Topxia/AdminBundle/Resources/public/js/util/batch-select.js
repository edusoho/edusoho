    ...
    module.exports = function($element) {
        $element.on('click', '[data-role=batch-select]', function(){
           if( $(this).is(":checked") == true){
				$('.js-batch-tag-btn, .js-batch-delete-btn, .js-batch-download, .js-batch-category-btn').attr('disabled', false);
                $element.find('[data-role=batch-select], [data-role=batch-item]').prop('checked', true);
            } else {
				$('.js-batch-tag-btn, .js-batch-delete-btn, .js-batch-download, .js-batch-category-btn').attr('disabled', true);
