    ...
    exports.run = function() {
        ...
        if($('#data').length > 0){
                    ...
                    Morris.Line({
                      ...
                      xkey: 'date',
                      ykeys: ['count'],
                      labels: [Translator.trans('admin.analysis.finished_lesson_total')],
                      xLabels:"day"
                    });
        }
        ...
        $('[name=endTime]').datetimepicker('setStartDate', $('#finishedLessonStartDate').attr("value"));
        ...
        $('[name=startTime]').datetimepicker('setStartDate', $('#finishedLessonStartDate').attr("value"));
