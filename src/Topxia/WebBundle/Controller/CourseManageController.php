...
class CourseManageController extends BaseController
{
    ...
    public function addStudentAction(Request $request, $id)
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            $member = $this->getCourseService()->joinCourse($user['id'], $course['id'], array('remarks'=>$formData['remarks']));
            $this->getOrderService()->createFreeOrderForSingle($user['id'], $course['id']);
        ...
        return $this->render('TopxiaWebBundle:CourseManage:add-student-modal.html.twig',array(
            'course'=>$course));
    }

    public function editStudentRemarksAction(Request $request, $courseId, $userId)
    {
        ...
        return $this->render('TopxiaWebBundle:CourseManage:edit-student-remarks-modal.html.twig',array(
            'member'=>$member,
            'user'=>$user,
            'course'=>$course));
    ...
    public function studentsAction(Request $request, $id)
    {
        ...
        return $this->render('TopxiaWebBundle:CourseManage:students.html.twig', array(
            'course' => $course,
            'students' => $students,
            'users'=>$users,
