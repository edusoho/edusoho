...
class MyTeachingController extends BaseController
{
    ...
    public function classroomsAction(Request $request)
    {
        ...
        $classrooms=$this->getClassroomService()->searchMembers(array('roles'=>array('teacher', 'headTeacher', 'assistant', 'studentAssistant'),'userId'=>$user->id),array('createdTime','desc'),0,9999);
