...
use Topxia\WebBundle\Extensions\DataTag\LatestCourseMembersDataTag;
...
{   
    ...
    {
    	$group = $this->getCategoryService()->addGroup(array('code' => 'course','name' => $this->getServiceKernel()->trans('课程分类'),'depth' => 2));
