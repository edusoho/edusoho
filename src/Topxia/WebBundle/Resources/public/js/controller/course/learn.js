                        ...
                        $.get('../../testpaper/' + lesson.mediaId + '/user_result/json', function(result) {
                            if (result.error) {
                                ...
                                if (result.status == 'nodo') {
                                    ...
                                    html = Translator.trans('试卷已批阅。' )+ '<a href="' + redoUrl + '" class="btn btn-default btn-sm" target="_blank">'+Translator.trans('再做一次')+'</a>' + '<a href="' + resultUrl + '" class="btn btn-link btn-sm" target="_blank">'+Translator.trans('查看结果')+'</a>';
