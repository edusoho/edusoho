define(function(require, exports, module) {
	...
	var homeworkFootCheck = Widget.extend({
        ...
        onClickCheckBtn: function(event) {
            ...
            var elementText = $('#homework-teacherSay-input').val();
            var teacherFeedback = {teacherFeedback:elementText};
            var passedStatusVal = $('input[type="radio"][name="passedStatus"]:checked').val();
            var passedStatus = {passedStatus:passedStatusVal};

            var data = $.extend(changeTeacherSay,teacherFeedback,passedStatus);
