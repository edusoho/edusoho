<?php
namespace Custom\Service\Cash\Impl;

use Topxia\Service\Cash\Impl\CashServiceImpl as TopxiaCashServiceImpl;
use Custom\Service\Cash\CashService;
use TopXia\Common\ArrayToolkit;
use TopXia\Service\Util\EasyValidator;

class CashServiceImpl extends TopxiaCashServiceImpl implements CashService
{
    ...
    {
        return $this->getFlowDao()->sumSignAmount($conditions);
    }
    ...
    {
        return $this->createDao('Custom:Cash.CashFlowDao');
    }
