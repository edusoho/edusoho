...
class WebExtension extends \Twig_Extension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            new \Twig_SimpleFunction('is_previous_lesson_learned', array($this, 'isPreviousLessonLearned'))
        );
    }

    public function isPreviousLessonLearned($id)
    {
        ...
        if ($course['studyModel'] == 'ordered') {
            ...
            foreach ($lessons as $tempLesson) {
                if ($tempLesson['seq'] < $lesson['seq']) {
                    $lessonLearnStatus = $this->getCourseService()->getUserLearnLessonStatus($user['id'], $course['id'], $tempLesson['id']);
