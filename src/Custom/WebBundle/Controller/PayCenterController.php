...
use Topxia\WebBundle\Controller\PayCenterController as TopxiaPayCenterController;

class PayCenterController extends TopxiaPayCenterController
{
    ...
    public function giveCoin($order)
    {
