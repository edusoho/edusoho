var CourseController = function($scope, $stateParams, CourseService, AppUtil, $state, cordovaUtil)
{
    ...
    CourseService.getCourse({
      ...
      $scope.courseView = app.customViewFloder + (data.member ? "view/course_learn.html" : "view/course_no_learn.html");
      $scope.hideLoad();
    });
...
app.controller('CustomCourseToolController', ['$scope', '$stateParams', 'OrderService', 'CourseService', 'cordovaUtil', '$state', CustomCourseToolController]);
function CustomCourseToolController($scope, $stateParams, OrderService, CourseService, cordovaUtil, $state)
{
...
app.controller('CustomCourseLessonController', ['$scope', '$stateParams', 'LessonService', '$state', 'cordovaUtil', CustomCourseLessonController]);
function CustomCourseLessonController($scope, $stateParams, LessonService, $state, cordovaUtil)
{
  var self = this;
  $scope.loading = true;
