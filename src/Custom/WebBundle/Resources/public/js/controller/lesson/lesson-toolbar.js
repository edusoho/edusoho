define(function(require, exports, module) {
  ...
  var LessonToolbar = Widget.extend({
    ...
    setup: function() {
      ...
      var QuestionPlugin = require('../../../../topxiaweb/js/controller/lesson/plugins/question/plugin');
      var NotePlugin = require('../../../../topxiaweb/js/controller/lesson/plugins/note/plugin');
      var MaterialPlugin = require('../../../../topxiaweb/js/controller/lesson/plugins/material/plugin');
      var HomeworkPlugin = require('../../../../topxiaweb/js/controller/lesson/plugins/homework/plugin');
