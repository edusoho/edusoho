...
class TestpaperController extends BaseController
{
    ...
    public function doTestpaperAction(Request $request, $testId, $lessonId)
    {
        ...
        if (!$testpaperResult) {
            $testpaperResult = $this->getTestpaperService()->startTestpaper($testId, $testpaper['type'], $testpaper['courseId'], $lessonId);
        }
        ...
        if (in_array($testpaperResult['status'], array('doing', 'paused'))) {
            ...
            return $this->redirect($this->generateUrl('testpaper_result_show', array('testId' => $testpaperResult['id'])));
        }
    }
    ...
    public function showResultAction(Request $request, $testId)
    {
