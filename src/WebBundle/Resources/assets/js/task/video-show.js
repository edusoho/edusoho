...
class VideoPlay {
    ...
    _playVideo() {
        ...
        var playerUrl = `/course/${this.data.courseId}/task/${this.data.taskId}/player`;// '../../course/' + lesson.courseId + '/lesson/' + lesson.id + '/player';
        if (startTime) {
    ...
    _playerSwf() {
        ...
        swfobject.embedSWF(this.data.ext.mediaUri,
