...
class HtmlExtension extends \Twig_Extension
{
    ...
    public function getFunctions()
    {
        ...
        return array(
            ...
            new \Twig_SimpleFunction('cg_radios', array($this, 'cgRadios'), $options),
    ...
    public function cgRadios($name, $choices, $checked = null, $disable = null)
    {
        $html = '';

        foreach ($choices as $value => $label) {
            if ($checked == $value) {
                $html .= "<label class=\"cg-radio checked\" data-toggle=\"radio\"><input type=\"radio\" name=\"{$name}\" value=\"{$value}\" {$disable} checked=\"checked\"> {$label}</label>";
            } else {
                $html .= "<label class=\"cg-radio\" data-toggle=\"radio\"><input type=\"radio\" name=\"{$name}\" value=\"{$value}\" {$disable}> {$label}</label>";
            }
        }
