...
class HtmlExtension extends \Twig_Extension
{
    ...
    public function cdRadios($name, $choices, $checked = null, $disable = null)
    {
        ...
        foreach ($choices as $value => $label) {
            if ($checked == $value) {
                $html .= "<label class=\"cd-radio checked\" data-toggle=\"radio\"><input type=\"radio\" name=\"{$name}\" value=\"{$value}\" {$disable} checked=\"checked\"> {$label}</label>";
            } else {
                $html .= "<label class=\"cd-radio\" data-toggle=\"radio\"><input type=\"radio\" name=\"{$name}\" value=\"{$value}\" {$disable}> {$label}</label>";
            }
        }
