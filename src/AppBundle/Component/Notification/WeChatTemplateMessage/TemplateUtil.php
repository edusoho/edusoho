    ...
    public static function templates()
    {
        $templates = array(
            ...
            'examResult' => array(
                'id' => 'OPENTM409257668',
                'name' => '考试结果通知',
                'content' => '{{first.DATA}}<br>考试科目：{{keyword1.DATA}}<br>考试成绩：{{keyword2.DATA}}<br>{{remark.DATA}',
                'object' => '试卷提交学员',
                'status' => 0,
            ),
            ...
            'coinRecharge' => array(
                'id' => 'OPENTM401498850',
                'name' => '充值成功通知',
                'content' => '{{first.DATA}}<br>充值类型：{{keyword1.DATA}}<br>充值订单号：{{keyword2.DATA}}<br>充值金额：{{keyword3.DATA}}<br>充值时间：{{keyword4.DATA}}<br>{{remark.DATA}}',
                'object' => '购买者',
                'status' => 0,
            ),
            'paySuccess' => array(
                'id' => 'OPENTM417184648',
                'name' => '购买成功通知',
                'content' => '{{first.DATA}}<br>订单详情：{{keyword1.DATA}}<br>订单价格：{{keyword2.DATA}}<br>订单时间：{{keyword3.DATA}}<br>{{remark.DATA}}',
                'object' => '购买者',
                'status' => 0,
            ),
        );
