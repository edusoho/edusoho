        ...
        foreach ($courseMembers as $userId => $members) {
            ...
            foreach ($members as $member) {
                ...
                $courseMemberData[$member['userId'].'-'.$member['courseId']] = [
                    ...
                    'sumTime' => empty($statistics[$member['courseId']]) ? 0 : array_sum(ArrayToolkit::column($statistics[$member['courseId']], 'sumTime')),
                    'pureTime' => empty($statistics[$member['courseId']]) ? 0 : array_sum(ArrayToolkit::column($statistics[$member['courseId']], 'pureTime')),
