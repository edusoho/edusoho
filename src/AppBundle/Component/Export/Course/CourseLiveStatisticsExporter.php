...
class CourseLiveStatisticsExporter extends Exporter
{
    ...
    public function getContent($start, $limit)
    {
        ...
        $checkInLiveStatistics = $this->getLiveStatisticsService()->findByLiveIdsAndType(array_values($activityLives), 'checkin');

        $historyLiveStatistics = $this->getLiveStatisticsService()->findByLiveIdsAndType(array_values($activityLives), 'history');
        ...
        foreach ($tasks as $task) {
            ...
            $checkinCount = empty($checkInLiveStatistics[$liveId]) ? 0 : count($checkInLiveStatistics[$liveId]['detail']);
    ...
    {
        return parent::export($name); // TODO: Change the autogenerated stub
    }
