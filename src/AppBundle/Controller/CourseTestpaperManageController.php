...
class CourseTestpaperManageController extends BaseController
{
    ...
    public function checkListAction(Request $request, $courseId)
    {
        ...
        return $this->render('AppBundle:CourseTestpaperManage:check-list.html.twig', array(
            'course'    => $course,
            'isTeacher' => $isTeacher
        ));
    }
    ...
    public function resultListAction(Request $request, $id, $testpaperId)
    {
        ...
        return $this->render('AppBundle:CourseTestpaperManage:result-list.html.twig', array(
            'course'    => $course,
            'testpaper' => $testpaper,
            'isTeacher' => $isTeacher
        ));
