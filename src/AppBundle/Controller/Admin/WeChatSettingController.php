...
class WeChatSettingController extends BaseController
{
    public function indexAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if (!$this->getWeChatService()->handleCloudNotification($wechatSetting, $newWeChatSetting, $loginConnect)) {
                ...
                return $this->render('admin/system/wechat-setting.html.twig', [
    ...
    public function preAuthUrlAction(Request $request, $platformType)
    {
        if ('official_account' == $platformType) {
            $url = $this->getWeChatService()->getPreAuthUrl(WeChatPlatformTypes::OFFICIAL_ACCOUNT, $this->generateUrl('admin_setting_wechat_auth', ['isCallback' => true], UrlGeneratorInterface::ABSOLUTE_URL));
        }
        if ('mini_program' == $platformType) {
            $url = $this->getWeChatService()->getPreAuthUrl(WeChatPlatformTypes::MINI_PROGRAM, $this->generateUrl('admin_setting_wechat_auth', [], UrlGeneratorInterface::ABSOLUTE_URL));
        }
