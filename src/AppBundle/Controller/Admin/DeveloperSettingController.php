...
class DeveloperSettingController extends BaseController
{
    public function indexAction(Request $request)
    {
        ...
        $default = array(
            ...
            'cloud_api_site_trace_server' => empty($storageSetting['cloud_api_site_trace_server']) ? '' : $storageSetting['cloud_api_site_trace_server'],
            'cloud_api_im_server' => '',
            'app_api_url' => '',
            'cloud_sdk_cdn' => '',
            'hls_encrypted' => '1',
        ...
        if ('POST' == $request->getMethod()) {
            ...
            $storageSetting['cloud_api_site_trace_server'] = $developerSetting['cloud_api_site_trace_server'];
