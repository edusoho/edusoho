...
class CouponBatchController extends BaseController
{
    ...
    public function generateAction(Request $request)
    {
        ...
        if (empty($couponSetting['enabled'])) {
            return $this->render('admin/coupon/permission-message.html.twig', ['type' => 'info']);
        }
        ...
        if ('POST' === $request->getMethod()) {
            ...
            $data = [
                'code' => true,
                'message' => '',
                'url' => $this->generateUrl('admin_coupon_batch_create', ['batchId' => $batch['id']]),
    ...
    public function batchCreateAction(Request $request, $batchId)
    {
        ...
        if ($generateNum >= 1000) {
            return $this->createJsonResponse(['code' => fase, 'message' => 'GenerateNum must be less than 1000']);
        }
    ...
    public function detailAction(Request $request, $batchId)
    {
        ...
        return $this->render('admin/coupon/coupon-modal.html.twig', [
            'coupons' => $coupons,
            'batch' => $batch,
            'paginator' => $paginator,
            'users' => $users,
    ...
    public function targetDetailAction(Request $request, $targetType, $batchId)
    {
        ...
        return $this->render('admin/coupon/target-modal.html.twig', [
            'targets' => $targets,
    ...
    public function getReceiveUrlAction(Request $request, $batchId)
    {
        ...
        return $this->render('admin/coupon/get-receive-url-modal.html.twig', [
            'batch' => $batch,
    ...
    public function chooserCouponAction(Request $request, $type)
    {
        ...
        return $this->render('admin/coupon/chooser-coupon/chooser-coupon-modal.html.twig', [
            'batchs' => $batchs,
            'type' => $type,
            'paginator' => $paginator,
        ]);
    ...
    public function chooserResourceListAction(Request $request, $batchId)
    {
        ...
        return $this->render('admin/coupon/chooser-coupon/coupon-batch-resource-list-modal.html.twig', [
            'batch' => $batch,
            'resources' => $resources,
        ]);
    }
