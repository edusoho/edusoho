...
class AppController extends BaseController
{
    public function centerAction(Request $request, $postStatus)
    {
        ...
        if (isset($apps['error'])) {
            return $this->render('admin-v2/cloud-center/app/center.html.twig', array('status' => 'error', 'type' => $postStatus));
        }

        if (!$apps) {
            return $this->render('admin-v2/cloud-center/app/center.html.twig', array('status' => 'unlink', 'type' => $postStatus));
        }
        ...
        return $this->render('admin-v2/cloud-center/app/center.html.twig', array(
            'apps' => $apps,
            'theme' => $theme,
            'allApp' => $app,
    ...
    public function installedAction(Request $request, $postStatus)
    {
        ...
        return $this->render('admin-v2/cloud-center/app/installed.html.twig', array(
            'apps' => $apps,
            'theme' => $theme,
            'plugin' => $plugin,
            'type' => $postStatus,
    ...
    public function upgradesAction()
    {
        ...
        if (isset($apps['error'])) {
            return $this->render('admin-v2/cloud-center/app/upgrades.html.twig', array('status' => 'error'));
        }

        $version = $this->getAppService()->getMainVersion();

        return $this->render('admin-v2/cloud-center/app/upgrades.html.twig', array(
            'apps' => $apps,
            'version' => $version,
        ));
    }
    ...
    public function logsAction()
    {
        ...
        return $this->render('admin-v2/cloud-center/app/logs.html.twig', array(
            'logs' => $logs,
            'users' => $users,
            'paginator' => $paginator,
        ));
