...
class TagGroupController extends BaseController
{
    public function indexAction(Request $request)
    {
        ...
        return $this->render('admin-v2/tag-group/index.html.twig', array(
            'tagGroups' => $tagGroups,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        if ($request->getMethod() == 'POST') {
            ...
            return $this->render('admin-v2/tag-group/list-tr.html.twig', array(
                'tagGroup' => $tagGroup,
            ));
        }

        return $this->render('admin-v2/tag-group/tag-group-modal.html.twig');
    }
    ...
    public function updateAction(Request $request, $groupId)
    {
        ...
        return $this->render('admin-v2/tag-group/tag-group-modal.html.twig', array(
            'tagGroup' => $tagGroup,
