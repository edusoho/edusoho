...
class AnnouncementController extends BaseController
{
    public function indexAction(Request $request)
    {
        ...
        return $this->render('admin-v2/operating/announcement/index.html.twig', array(
            'paginator' => $paginator,
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('admin-v2/operating/announcement/create.html.twig');
    }
    ...
    public function editAction(Request $request, $id)
    {
        ...
        return $this->render('admin-v2/operating/announcement/create.html.twig', array(
