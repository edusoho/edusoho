...
class SensitiveController extends BaseController
{
    public function indexAction(Request $request)
    {
        ...
        return $this->render('sensitive-admin/index.html.twig', array(
            'keywords'  => $keywords,
            'paginator' => $paginator
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('sensitive-admin/keyword-add.html.twig');
    }
    ...
    public function banlogsAction(Request $request)
    {
        ...
        return $this->render('sensitive-admin/banlogs.html.twig', array(
            'banlogs'   => $banlogs,
            'users'     => $users,
            'paginator' => $paginator
        ));
