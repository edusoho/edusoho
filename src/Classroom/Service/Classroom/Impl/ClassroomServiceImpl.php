...
class ClassroomServiceImpl extends BaseService implements ClassroomService
{
    ...
    {
        $fields = ArrayToolkit::parts($fields, array('rating', 'ratingNum', 'categoryId', 'title', 'status', 'about', 'description', 'price', 'vipLevelId', 'smallPicture', 'middlePicture', 'largePicture', 'headTeacherId', 'teacherIds', 'assistantIds' , 'hitNum', 'auditorNum', 'studentNum', 'courseNum', 'lessonNum', 'threadNum', 'postNum', 'income', 'createdTime', 'private', 'service','buyable','showable'));
    ...
    public function updateClassroomTeachers($id)
    {
        ...
        foreach ($courses as $key => $value) {
            ...
            $newTeacherIds = array_merge($newTeacherIds, $course['teacherIds']);
        }
