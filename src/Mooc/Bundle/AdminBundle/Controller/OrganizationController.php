...
class OrganizationController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('MoocAdminBundle:Organization:index.html.twig', array(
    ...
    public function editAction(Request $request, $id)
    {
        ...
        return $this->render('MoocAdminBundle:Organization:modal.html.twig', array(
    ...
    {
        $organizations = $this->getOrganizationService()->getOrganizationTree();
        return $this->render('MoocAdminBundle:Organization:tbody.html.twig', array(
            'organizations' => $organizations
        ));
    }
