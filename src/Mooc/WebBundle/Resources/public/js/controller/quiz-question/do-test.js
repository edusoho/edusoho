define(function(require, exports, module) {
    ...
    require('es-ckeditor');
    require('../../../../topxiaweb/js/controller/widget/document-player');

    var AudioPlayer = require('../../../../topxiaweb/js/controller/quiz-question/audioplayer');
    var playedQuestions = [];
...
// 学生查看试卷结果
        ...
        $('.testpaper-question-essay-input-short').focusin(function(e) {
            ...
            var $attachment = $shortTextarea.parent().find('.question-attachment').show();
            ...
            $attachment.on('click', function () {
                var url = $attachment.children('a').data("url");
