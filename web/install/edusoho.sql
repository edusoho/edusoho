...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='文章素材表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `block_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='历史表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `carts` (
  ...
  `userId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '购买者Id',
  `userKey` varchar(255) NOT NULL DEFAULT '0' COMMENT '用户key',
  `createdTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '购买时间',
  PRIMARY KEY (`id`),
  KEY `userKey` (`userKey`)
...
CREATE TABLE `category` (
  ...
  `weight` int(11) NOT NULL DEFAULT '0',
  `isSubject` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否是科目',
...
CREATE TABLE `cloud_app` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='已安装的应用';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course` (
  ...
  `categoryId` int(10) unsigned NOT NULL DEFAULT '0',
  `subjectIds` varchar(255) NOT NULL COMMENT '学科Ids',
  `tags` text,
  `tagIds` varchar(255) DEFAULT NULL COMMENT '标签ids',
...
CREATE TABLE `course_favorite` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='用户的收藏数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course_lesson` (
  ...
  `coursewareId` int(10) unsigned NOT NULL DEFAULT '0',
  `number` int(10) unsigned NOT NULL,
  `seq` int(10) unsigned NOT NULL,
...
CREATE TABLE `course_note` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '笔记状态：0:私有, 1:公开',
...
CREATE TABLE `course_review` (
  ...
  `isInit` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否是初始评价',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='课程包课程从属关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `courseware` (
  ...
  `knowledgeIds` varchar(255) NOT NULL COMMENT '知识点id',
  `categoryId` int(10) NOT NULL,
  `tagIds` varchar(255) NOT NULL COMMENT '标签',
  `source` varchar(255) NOT NULL COMMENT '来源',
  `userId` int(10) NOT NULL COMMENT '创建人Id',
  `createdTime` int(10) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `mainKnowledgeId` (`mainKnowledgeId`),
  KEY `categoryId` (`categoryId`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='课件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `essay_chapter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `essay_chapter` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='文章章节表';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `essay_relation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `essay_relation` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `articleId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文章id',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='文章关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `exercise` (
  ...
  `lessonId` int(10) unsigned NOT NULL,
  `tagIds` varchar(255) DEFAULT NULL COMMENT '标签Ids',
  `knowledgeIds` varchar(255) DEFAULT NULL COMMENT '知识点Ids',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='作业';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `knowledge` (
  ...
  `isHidden` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '知识点是否隐藏',
  `categoryId` int(10) unsigned NOT NULL COMMENT '知识点分类',
  `createdTime` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `usedNum` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '被使用次数',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `media_lesson_exercise`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `media_lesson_exercise` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '系统id',
  `lessonId` int(10) unsigned NOT NULL COMMENT '课时id',
  `questionId` int(10) unsigned NOT NULL COMMENT '问题id',
  `showtime` int(10) unsigned NOT NULL COMMENT '题目出现时间',
  `createdTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='课中练习表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `payment` enum('none','alipay','tenpay','coin') NOT NULL DEFAULT 'none',
  `coinAmount` float(10,2) NOT NULL,
...
CREATE TABLE `question` (
  ...
  `mainKnowledgeId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '主知识点id',
  `relatedKnowledgeIds` varchar(255) NOT NULL COMMENT '关联知识点ID',
  `knowledgeIds` varchar(10240) NOT NULL DEFAULT '',
  `tagIds` varchar(255) NOT NULL COMMENT 'tagsIds',
  ...
  `createdTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='问题表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tag_group` (
  ...
  `createdTime` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='标签组';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `testpaper` (
  ...
  `knowledgeIds` varchar(1024) NOT NULL DEFAULT '',
  `tagIds` varchar(1024) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
...
CREATE TABLE `testpaper_item` (
  ...
  `partId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '试卷部分Id',
  `parentId` int(10) unsigned NOT NULL DEFAULT '0',
  `score` float(10,1) unsigned NOT NULL DEFAULT '0.0' COMMENT '分值',
  `missScore` float(10,1) unsigned NOT NULL DEFAULT '0.0',
  `mistakeScore` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '错选扣分',
  PRIMARY KEY (`id`)
