define(function(require, exports, module) {
    ...
    exports.create = function(object) {
        ...
        var itemsAll = ['weixin','tsina','renren','qq'];
        ...
        if(type=="dropdown"){
            ...
            var html='<a class="dropdown-toggle"  href="javascript:" id="dropdownMenu1" data-toggle="dropdown" ><span class="icon-share"></span></a><ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1"><div class="bdsharebuttonbox" style="padding:1px;">';
        }else{
