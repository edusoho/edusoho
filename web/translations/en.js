...
t.add("admin_v2.video_effective_time_setting.cancel.hint", "When the statistical dimension of video lesson learning hours is changed, the data will be generated according to the new rules, which may lead to a large change in the data, which is a normal phenomenon. Data will be updated in about 3 hours, we do not recommend you to change the statistical dimension frequently. <br\/>Do you confirm to change the statistical dimension of learning time?", "js", "en");
