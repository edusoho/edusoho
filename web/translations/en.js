...
t.add("site.captcha_code.required", "Please drag the captcha code", "js", "en");
...
t.add("site.data.add_check_name_hint", "Are you sure to add the selected bar %name%?", "js", "en");
t.add("site.data.delete_title_hint", "Delete %name%", "js", "en");
t.add("site.data.add_title_hint", "Add %name%", "js", "en");
...
t.add("uploader.size_5m_limit_hint", "File too large, please upload files under 5M.", "js", "en");
...
t.add("activity.audio_manage.length_required_error_hint", "Please enter a non negative integer, where seconds can only be between 0-59", "js", "en");
...
t.add("Site.date_format_s", "Seconds %seconds%", "js", "en");
t.add("Site.delete_success_hint", "Deleted successfully", "js", "en");
t.add("Site.add_success_hint", "Add successfully", "js", "en");
t.add("Site.delete_fail_hint", "Delete failed", "js", "en");
t.add("Site.add_fail_hint", "Add failed", "js", "en");
t.add("Site.upload_success_hint", "Uploaded successfully", "js", "en");
t.add("Site.upload_fail_retry_hint", "Upload failed, please try again", "js", "en");
t.add("Site.save_success_hint", "Saved successfully", "js", "en");
...
t.add("activity.testpaper_manage.media_type_required", "Please select the testpaper types", "js", "en");
t.add("activity.testpaper_random", "Random testpaper", "js", "en");
t.add("activity.testpaper_regular", "Regular testpaper", "js", "en");
...
t.add("activity.testpaper_manage.default_comment", "Default Comment", "js", "en");
t.add("activity.testpaper_manage.default_comment1", "Keep working hard and keep improving!", "js", "en");
t.add("activity.testpaper_manage.default_comment2", "Yes, if there is progress, it will be even better if you work harder!", "js", "en");
t.add("activity.testpaper_manage.default_comment3", "You are awesome! I am proud of you!", "js", "en");
t.add("activity.testpaper_manage.default_comment4", "A little slack, right? Keep going!", "js", "en");
t.add("activity.testpaper_manage.default_comment5", "With heart, focus and persistence, you can do better!", "js", "en");
t.add("activity.testpaper_manage.comment_remove", "Remove", "js", "en");
...
t.add("activity.video.only_can_app_title", "The configuration has changed and the course cannot be played", "js", "en");
t.add("activity.video.only_can_app_desc", "Please go to the App to continue learning", "js", "en");
t.add("activity.video.file_limit_size", "File size cannot exceed %size%", "js", "en");
...
t.add("created.question.confirm.import.close.btn", "Direct import", "js", "en");
t.add("created.question.confirm.title", "The same topic already exists. Do you want to create another one?", "js", "en");
t.add("created.question.confirm.import.title", "If the same topic already exists, determine whether to continue importing?", "js", "en");
...
t.add("course.manage.show_fail_hint", "Enable failed", "js", "en");
...
t.add("course.manage.task_batch_delete_hint", "After deleting the selected lesson, the corresponding tasks under the lesson will be deleted. The lessons in the unpublished state will be deleted, and the lessons in the published state need to be cancelled and then deleted. Do you want to continue deleting %length% lesson this time?", "js", "en");
...
t.add("course.question.by.question.type", "By question type", "js", "en");
...
t.add("course.question.type.uncertain_choices", "uncertain choice", "js", "en");
...
t.add("item_bank_exercise.student_create.price_min_error_hint", "The price can not be less than 0!", "js", "en");
t.add("item_bank_exercise.student_create.price_max_error_hint", "The price can not exceed the orignial price of the item bank exercise.", "js", "en");
t.add("item_bank_exercise.assessment_module.assessment_delete", "Sure you want to remove the current paper?", "js", "en");
t.add("item_bank_exercise.assessment_module.assessment_delete.title", "Remove Paper", "js", "en");
t.add("item_bank_exercise.assessment_module.module_delete.title", "Remove Module", "js", "en");
t.add("item_bank_exercise.assessment_module.module_delete", "Sure you want to remove the current module?", "js", "en");
t.add("item_bank_exercise.assessment_module.module_delete.has_assessment_hint", "Sure you continue to remove papers that exist under the current module?", "js", "en");
t.add("item_bank_exercise.assessment_module.module_delete.least_module_count_hint", "lease keep at least one module", "js", "en");
t.add("item_bank_exercise.module.switch.danger", "At the time of publication of the item bank exercise, at least one chapter exercise or assessment exercise must be enabled", "js", "en");
...
t.add("validate.unsigned_integer.student_message", "Please enter an integer not less than 0", "js", "en");
t.add("validate.unsigned_integer.message", "Please enter a non negative integer, where seconds can only be between 0-59", "js", "en");
t.add("validate.second_range.message", "Please enter a non negative integer, where seconds can only be between 0-59", "js", "en");
...
t.add("exception.course.closed.content", "The current course is closed.", "js", "en");
t.add("exception.classroom.closed.content", "The current classroom is closed.", "js", "en");
t.add("exception.exercise.closed.content", "The current question bank is closed.", "js", "en");
...
t.add("validate_old.currency.message", "You can only enter up to %max% characters\uff0cone Chinese word counts as two characters.", "js", "en");
...
t.add("admin.classroom.delist_hint", "After the class is removed, it will not be displayed at the front desk, and students will not be able to view it on the home page and list page.", "js", "en");
...
t.add("admin.course.publish_success_hint", "Course published successfully", "js", "en");
t.add("admin.course.publish_failed_hint", "Failed to publish the course", "js", "en");
t.add("admin.course.close_success_hint", "Course closed successfully", "js", "en");
t.add("admin.course.close_failed_hint", "Failed to close the course", "js", "en");
...
t.add("admin.course.hide_course_hint", "After the course is removed, it will not be displayed at the front desk, and students will not be able to view it on the home page and list page.", "js", "en");
...
t.add("admin.group.recommend_success_hint", "Recommend group successfully!", "js", "en");
t.add("admin.group.recommend_fail_hint", "Recommend group failed!", "js", "en");
t.add("admin.group.delete_hint", "Deleting a group will delete the group\u2019s topics, members, and replies. Do you really want to delete this group?", "js", "en");
...
t.add("admin.setting.consult_setting.setting_consult_phone.empty_hint", "Not Empty", "js", "en");
t.add("admin.setting.consult_setting.setting_consult_name.empty_hint", "Not People", "js", "en");
t.add("admin.setting.consult_setting.setting_consult_phone.error_hint", "Not Set", "js", "en");
...
t.add("admin.item_bank_exercise.exercise.hide_hint", "Question bank exercises will not be displayed at the front desk after they are removed from the shelves, and students cannot view them on the home page and list page.", "js", "en");
t.add("admin.item_bank_exercise.exercise.close_success_hint", "Close successfully", "js", "en");
t.add("admin.item_bank_exercise.exercise.close_hint", "Students who are still valid after closing cannot continue learning. Exercise caution when performing this operation.", "js", "en");
...
t.add("wechat.notification.wechat_subscribe_bind_hover", "<div class=\"wechat-intro-title cd-text-warning\"><i class=\"es-icon es-icon-xinxi cd-mr8\"><\/i>Prompt<\/div>\n  <div class=\"wechat-intro-content\">\n    <div>In order to enjoy better service, we suggest you pay attention to the service number.<\/div>\n    <div>Click here to bind wechat.<\/div>\n  <\/div>\n", "js", "en");
...
t.add("admin.wechat_notification.message_subscribe.disable_setting_tip", "Please authorize the website to generate wechat notification template", "js", "en");
...
t.add("classroom.tag_label", "Tag", "js", "en");
t.add("classroom.category_label", "Category", "js", "en");
t.add("classroom.manage.set_info.tags.help_block", "Used to query classes by label, and managed by administrator", "js", "en");
t.add("category", "Category", "js", "en");
t.add("site.org", "Org", "js", "en");
t.add("classroom.about", "about", "js", "en");
t.add("classroom.cover_image", "Cover", "js", "en");
t.add("classroom.cover_image.upload_tips", "Please upload images in jpg, gif, png format. The recommended image size is 480\u00d7270px. It is recommended that the image size should not exceed 2MB.", "js", "en");
t.add("editor.iframe_tips", "To use IFrame normally, please set it in [Admin] - [System] -[Security] -[White List Domain]", "js", "en");
t.add("classroom.upload_picture_btn", "Upload an image", "js", "en");
t.add("classroom.marketing_setting", "Marketing Setting", "js", "en");
t.add("classroom.price_label", "Price", "js", "en");
t.add("classroom.show_label", "Show %name%", "js", "en");
t.add("classroom.show_page_label", "Page Display", "js", "en");
t.add("classroom.show_page_tips", "After closing, the classroom will be completely hidden and cannot be viewed on the front-end.", "js", "en");
t.add("classroom.buy_label", "Buy %name%", "js", "en");
t.add("classroom.expiry_mode_label", "Expired on", "js", "en");
t.add("classroom.watch_expiry_mode_rule", "View the rule", "js", "en");
t.add("classroom.expiry_mode.first_publish_tips", "Expiry mode can not be edited since the classroom was published", "js", "en");
t.add("classroom.expiry_mode_end_date_tips", "If set\uff0cstudent can only study before the deadline. The system will remind students by 10 days before the deadline.\n", "js", "en");
t.add("classroom.expiry_mode_days_tips", "If set\uff0cstudent can only study before the deadline. The system will remind students by 10 days before the deadline.\n", "js", "en");
t.add("classroom.expiry_mode_end_date", "Expired on", "js", "en");
t.add("classroom.expiry_mode_days", "Effective days", "js", "en");
t.add("classroom.expiry_mode_forever", "Forever", "js", "en");
t.add("classroom.price_tips", "Total %courseNum% courses, original %price% CNY.\n", "js", "en");
t.add("classroom.amount", "Equals to ", "js", "en");
t.add("site.open", "Open", "js", "en");
t.add("site.show", "Display", "js", "en");
t.add("site.hide", "Hide", "js", "en");
t.add("site.date.day", "Day", "js", "en");
t.add("course.marketing_setup.services.provide_services", "Services", "js", "en");
t.add("course.marketing_setup.services.course_list_display", "Task List With Goods", "js", "en");
t.add("vip.level.free_learning", "Free for Vip", "js", "en");
t.add("vip.level.free_learning_new", "Free for Vip", "js", "en");
t.add("site.default.none", "None", "js", "en");
t.add("form.btn.save", "Save", "js", "en");
t.add("drainage.setting", "Drainage settings", "js", "en");
t.add("drainage.qr_setting", "QR code settings", "js", "en");
t.add("drainage.upload_tips", "Please upload pictures in jpg, gif, png format", "js", "en");
t.add("drainage.text", "Drainage copy", "js", "en");
t.add("drainage.placeholder", "Please enter content", "js", "en");
t.add("drainage.style", "Drain page style", "js", "en");
t.add("drainage.style_tips", "Join\/Payment Completion Page", "js", "en");
t.add("drainage.view_detail", "see details", "js", "en");
t.add("drainage.qr_no_empty", "QR code cannot be empty", "js", "en");
t.add("drainage.setting_tips", "Drain purchased users to the private domain traffic pool", "js", "en");
t.add("site.twig.extension.smarttime.future", "Feature", "js", "en");
t.add("site.twig.extension.smarttime.hardly", "A moment ago", "js", "en");
t.add("site.twig.extension.smarttime.previous_second", "%diff% second ago", "js", "en");
t.add("site.twig.extension.smarttime.previous_minute", "%diff% minute ago", "js", "en");
t.add("site.twig.extension.smarttime.previous_hour", "%diff% hour ago", "js", "en");
t.add("site.twig.extension.smarttime.previous_day", "%diff% day ago", "js", "en");
t.add("reviews.review_again", "Review Again", "js", "en");
t.add("classroom.courses.lesson_num", "%num% lessons total", "js", "en");
t.add("classroom.courses.plan", "plan", "js", "en");
t.add("site.local_more", "loading more", "js", "en");
t.add("exception.s2b2c_product.adopt_failed", "Adopt fail,Supplier is editing", "js", "en");
t.add("admin_v2.certificate.template.delete_hint", "When a template is deleted, the certificates that use the templates Are templates deleted?", "js", "en");
t.add("admin_v2.certificate.code.exist", "This certificate code already exists", "js", "en");
t.add("admin_v2.certificate.code.check", "1 to 20 digits or letters of the alphabet, not case sensitive", "js", "en");
t.add("admin_v2.certificate.expiry_day.check", "Please enter a non-negative integer from 1 to 6000", "js", "en");
t.add("admin_v2.certificate.target_id.check", "Please select the target group", "js", "en");
t.add("admin_v2.certificate.template_id.check", "Please select a certificate template", "js", "en");
t.add("admin_v2.certificate.close.hint", "After the certificate is closed, the student will no longer be able to obtain the certificate and users who have already obtained the certificate will not be affected. Is it closed?", "js", "en");
t.add("admin_v2.certificate.close.success_hint", "close success", "js", "en");
t.add("admin_v2.certificate.close.failure_hint", "close failure", "js", "en");
t.add("admin_v2.certificate.publish.hint", "Are you sure you want to issue a certificate?", "js", "en");
t.add("admin_v2.certificate.publish.success_hint", "publish success", "js", "en");
t.add("admin_v2.certificate.publish.failure_hint", "publish failure", "js", "en");
t.add("admin_v2.certificate.delete.hint", "After the certificate is deleted, you cannot view the user list and audit list of the certificate. Users who have acquired the certificate can no longer view the certificate. Is the certificate deleted?", "js", "en");
t.add("admin_v2.certificate.delete.draft_hint", "The certificate has not yet been issued, is it certain to be removed?", "js", "en");
t.add("admin_v2.certificate.delete.success_hint", "delete success", "js", "en");
t.add("admin_v2.certificate.delete.failure_hint", "delete failure", "js", "en");
t.add("admin_v2.certificate.record.cancel.hint", "Confirm revocation of certificate?", "js", "en");
t.add("admin_v2.certificate.record.cancel.success_hint", "cancel success", "js", "en");
t.add("admin_v2.certificate.record.cancel.failure_hint", "cancel failure", "js", "en");
t.add("admin_v2.certificate.record.grant.success_hint", "grant success", "js", "en");
...
t.add("s2b2c.product.suggestion_price", "Suggestion Price", "js", "en");
t.add("s2b2c.resource.sync.prev_price.notify", "The price of the previous version was", "js", "en");
t.add("site.price", "Price", "js", "en");
t.add("course.marketing_setup.setup.can_join", "Can join", "js", "en");
t.add("course.marketing_setup.setup.can_not_join", "Can not join", "js", "en");
t.add("course.marketing_setup.setup.is_show_label", "Page display", "js", "en");
...
t.add("course.marketing_setup.expiry_date.anytime", "Any time", "js", "en");
t.add("course.marketing_setup.expiry_date.custom", "Custom", "js", "en");
t.add("site.datagrid.radios.yes", "Yes", "js", "en");
t.add("site.datagrid.radios.no", "No", "js", "en");
t.add("course.teaching_plan.expiry_date.end_date_mode", "Expiration date mode", "js", "en");
t.add("course.teaching_plan.expiry_date.days_mode", "Valid days mode", "js", "en");
t.add("course.teaching_plan.expiry_date.anywhere_mode", "Pick-up study", "js", "en");
t.add("course.teaching_plan.expiry_date.date_mode", "Fix time", "js", "en");
t.add("course.teaching_plan.expiry_date.forever_mode", "Permanet", "js", "en");
t.add("course.teaching_plan.expiry_date.anytime", "<b>pick-up study\uff1a<\/b>the expiry date is count from the day when student enroll in the course to 23:59 o'clock of the last day.\n", "js", "en");
t.add("course.teaching_plan.expiry_date.real_time", "<b>fixed time:<\/b>course started and finished at fixed time", "js", "en");
t.add("course.teaching_plan.expiry_date.overdue_tips", "Student can not study if expired. System will inform the student 10 days before expired.", "js", "en");
t.add("course.base_info", "Basic info", "js", "en");
t.add("course.plan_setup.name", "Program name", "js", "en");
t.add("course.plan_setup.placeholder", "Please enter the plan name", "js", "en");
t.add("course.plan_setup.subtitle", "Plan subtitle", "js", "en");
t.add("course.base.title", "Title", "js", "en");
t.add("course.base.sub_title", "Subtitle", "js", "en");
t.add("course.base.tag", "Tag", "js", "en");
t.add("course.base.tag_tips", "Used to search courses. Managed by site administrator.", "js", "en");
t.add("course.base.category", "Category", "js", "en");
t.add("course.base.serialize_mode", "To be continued", "js", "en");
t.add("course.base.serialize_mode.none", "Non Serial", "js", "en");
t.add("course.base.serialize_mode.serialized", "In the series", "js", "en");
t.add("course.base.serialize_mode.finished", "Series end", "js", "en");
t.add("course.cover_image.content_title", "Cover", "js", "en");
t.add("course.cover.change", "Cover change", "js", "en");
t.add("course.cover_image.upload_tips", "You can upload jpg, gif, png files, suggest size could be 480x270px. <br>The maxium size should less than <strong>2MB<\/strong>.\n", "js", "en");
t.add("course.detail.summary", "About", "js", "en");
t.add("course.base_setup.rules", "Basic rule", "js", "en");
t.add("course.plan_setup.mode", "Learn mode", "js", "en");
t.add("course.plan_setup.mode.free", "Free", "js", "en");
t.add("course.plan_setup.mode.locked", "Lock", "js", "en");
...
t.add("course.plan_setup.finish_rule.depend_on_finish_condition_tips", "Student should meet determined conditions to finish the %taskName%", "js", "en");
t.add("course.plan_setup.member_numbers", "Limit the number of participants", "js", "en");
t.add("course.plan_setup.member_numbers.tips", "There is a limit on the number of people who can join the live course, 0 means no limit on the number of people", "js", "en");
t.add("site.data.people", "Person", "js", "en");
t.add("course.plan_setup.member_numbers.view_rule_btn", "[check the live course information]", "js", "en");
t.add("course.marketing_setup.preview.set_task", "Free %taskName%", "js", "en");
t.add("course.marketing_setup.preview.set_task.task_name", "%name%%taskName%", "js", "en");
t.add("course.marketing_setup.preview.set_task.free", "Free", "js", "en");
t.add("course.marketing_setup.preview.set_task.free_tips", "Free lesson %taskName% only support", "js", "en");
t.add("course.marketing_setup.preview.try_watch", "Preview", "js", "en");
...
t.add("course.marketing_setup.preview.not.support.try_watch", "Do not support trial", "js", "en");
t.add("course.info.video.convert.audio.start", "Open", "js", "en");
t.add("course.info.video.convert.audio.close", "Close", "js", "en");
t.add("course.marketing_setup.rule.watch_time_limit.watch_limit_tips", "Eg.: The total video duration of the course is 100 minutes. If you set 5 times, then students can watch videos for 500 minutes. 0 means no limits.<br\/>It only affect the video upload manually. It won't affect record live or videos saved on third party live platform.", "js", "en");
t.add("goods.show_page.tab.intro", "Goods Intro", "js", "en");
t.add("goods.show_page.tab.question_bank", "Question Bank", "js", "en");
t.add("goods.show_page.tab.question_bank.show", "View All", "js", "en");
t.add("goods.show_page.tab.question_bank.empty", "There is no bound question bank for now~", "js", "en");
t.add("goods.show_page.tab.question_bank.chapter_exercise", "Chapter Exercises", "js", "en");
t.add("goods.show_page.tab.question_bank.test_paper_practice", "Test Paper Practice", "js", "en");
t.add("goods.show_page.tab.question_bank.check", "Check", "js", "en");
t.add("goods.show_page.tab.question_bank.close", "Close", "js", "en");
t.add("goods.show_page.tab.catalogue", "Learn Catalogue", "js", "en");
t.add("goods.show_page.tab.catalogue.empty", "After purchasing, you can view the course catalog~", "js", "en");
...
t.add("goods.show_page.components.recommends", "Recommends Goods", "js", "en");
t.add("goods.show_page.load_more", "Load more", "js", "en");
t.add("goods.show_page.more", "More", "js", "en");
t.add("goods.show_page.goto_school", "Goto homepage", "js", "en");
t.add("goods.show_page.components.teachers", "Teachers", "js", "en");
t.add("goods.show_page.components.expiry_mode", "Expiry Mode", "js", "en");
t.add("goods.show_page.components.expiry_mode.forever", "Forever", "js", "en");
t.add("goods.show_page.components.expiry_mode.forever_tips", "Learn Anytime", "js", "en");
t.add("goods.show_page.components.expiry_mode.date_start", "Start", "js", "en");
t.add("goods.show_page.components.expiry_mode.date_end", "End", "js", "en");
t.add("goods.show_page.components.expiry_mode.date_end_label", "End Date", "js", "en");
t.add("site.course_plan", "Plan", "js", "en");
t.add("goods.show_page.components.services", "Services", "js", "en");
t.add("site.share", "Share", "js", "en");
t.add("site.manage", "Manage", "js", "en");
t.add("goods.show_page.goto_learn", "Goto Learn", "js", "en");
t.add("goods.show_page.vip_free_learn", "Vip Free Learn", "js", "en");
t.add("goods.show_page.vip_free_learn_new", "Free exchange for vip", "js", "en");
...
t.add("activity.replay_manage.replay_error_hint", "Please select live replay", "js", "en");
t.add("site.btn.export", "Export", "js", "en");
t.add("site.btn.detail", "More", "js", "en");
t.add("site.btn.remove_playback", "Remove playback", "js", "en");
t.add("site.btn.view_playback", "View playback", "js", "en");
t.add("site.btn.confirm", "Confirm", "js", "en");
t.add("site.btn.edit", "Edit", "js", "en");
t.add("site.btn.see_more", "All", "js", "en");
t.add("site.btn.enter_live", "Enter live", "js", "en");
t.add("site.btn.save", "Save", "js", "en");
t.add("site.btn.exit_editing", "Exit editinng", "js", "en");
t.add("site.btn.preview", "Preview", "js", "en");
t.add("site.btn.exit_preview", "Exit preview", "js", "en");
t.add("admin.mobile_setting.discovery_tips", "Notice\uff1aUsing the discovery page configuration function, the app version needs to be upgraded to 4.5.39 and above", "js", "en");
t.add("modal.title.edit", "Edit", "js", "en");
t.add("modal.content.remove_playback_resources", "Are you sure to remove playback resources?", "js", "en");
t.add("form.label.tag", "Tag", "js", "en");
...
t.add("message.removal_succeeded", "Removal succeeded", "js", "en");
t.add("message.edit_succeeded", "Edit succeeded", "js", "en");
t.add("message.file_too_large", "The file is too large, please upload a file smaller than 2M!", "js", "en");
t.add("message.saved_successfully", "Saved successfully!", "js", "en");
t.add("message.save_failed", "Save failed!", "js", "en");
t.add("message.coupon_module_information", "Please complete the coupon module information!", "js", "en");
t.add("message.gn_module_information", "Please complete the graphic navigation module information!", "js", "en");
t.add("message.advertising_module_information", "Please complete the advertising module information!", "js", "en");
t.add("message.qusetion_bank_module_information", "Please complete the question bank module information!", "js", "en");
t.add("message.open_class_module_information", "Please complete the open class module information!", "js", "en");
t.add("message.classroom_module_information", "Please complete the class module information!", "js", "en");
t.add("message.course_module_information", "Please complete the course module information!", "js", "en");
t.add("message.carousel_module_information", "Please complete the carousel picture module information!", "js", "en");
t.add("message.go_to_open", "Go to open", "js", "en");
t.add("message.coupon_function_is_not_activated", "Coupon function is not activated", "js", "en");
t.add("message.membership_function_is_not_activated", "Membership function is not activated", "js", "en");
t.add("message.add_up_to", "Add up to 5 components of the same type", "js", "en");
t.add("live.playback.tip.remove_association", "Live playback will remove the association from the course", "js", "en");
t.add("live.playback.tip.cannot_be_used_normally", "If the live playback is referenced, removing it will cause the referenced task to be unable to work normally", "js", "en");
t.add("live.playback.tip.delete_related_live_playback", "At the same time, delete relevant live playback in my teaching materials", "js", "en");
t.add("course.name", "Course title", "js", "en");
t.add("course.task", "Task title", "js", "en");
t.add("live_name", "Name", "js", "en");
t.add("live_playback_duration", "Playback duration", "js", "en");
t.add("live_statistics", "Live statistics", "js", "en");
t.add("live_statistics.task_name_placeholder", "Task name", "js", "en");
t.add("live_statistics.live_start_time", "Start time", "js", "en");
t.add("live_statistics.live_type", "Type", "js", "en");
t.add("live_type.default", "Default Live", "js", "en");
t.add("live_type.pseudo", "Smart Live", "js", "en");
t.add("live_statistics.live_time_long", "Duration(min)", "js", "en");
t.add("live_statistics.max_participate_count", "Max oarticipate count", "js", "en");
t.add("live_statistics.live_status", "Status", "js", "en");
t.add("live_statistics.operation", "Operation", "js", "en");
t.add("live_statistics.live_coming", "Comming soon", "js", "en");
t.add("live_statistics.live_playing", "Playing", "js", "en");
t.add("live_statistics.live_finished", "Finished", "js", "en");
t.add("live_statistics.detail_notice", "The data comes from the live room, which is automatically synchronized one day after the live", "js", "en");
t.add("live_statistics.detail.checkin", "Checkin Statistics", "js", "en");
t.add("live_statistics.detail.total_learn_time", "Learning Duration Statistics", "js", "en");
t.add("live_statistics.checkin_status", "Checkin status", "js", "en");
t.add("live_statistics.checkin_status.checked", "Checked", "js", "en");
t.add("live_statistics.checkin_status.not_checked", "Not checked", "js", "en");
t.add("live_statistics.checkin_status.all", "All", "js", "en");
t.add("live_statistics.mobile", "Mobile", "js", "en");
t.add("live_statistics.email", "Email", "js", "en");
t.add("live_statistics.user_name", "User name", "js", "en");
t.add("live_statistics.true_name", "Name", "js", "en");
t.add("live_statistics.user_name_or_mobile_number", "User name or mobile number", "js", "en");
t.add("live_statistics.presenter", "Presenter", "js", "en");
t.add("live_statistics.live_time", "Live time", "js", "en");
t.add("live_statistics.actual_live_time", "Actual live time", "js", "en");
t.add("live_statistics.all_chat_number", "Chat number", "js", "en");
t.add("live_statistics.online_number", "Online number", "js", "en");
t.add("live_statistics.number_of_visitors", "Number of visitors", "js", "en");
t.add("live_statistics.per_capita_viewing_time", "Per capita viewing time", "js", "en");
t.add("live_statistics.enter_theLlive_room_time", "Enter the live room time", "js", "en");
t.add("live_statistics.watching_time", "Watching time (minutes)", "js", "en");
t.add("live_statistics.check_in_number", "Check in number", "js", "en");
t.add("live_statistics.chat_number", "Number of chat", "js", "en");
t.add("live_statistics.answers_number", "Number of answers", "js", "en");
t.add("live_statistics.to", "to", "js", "en");
t.add("live_statistics.people", "people", "js", "en");
t.add("live_statistics.strip", "strip", "js", "en");
t.add("course.live_replay.share_btn", "Share", "js", "en");
t.add("course.live_replay.un_share_btn", "UnShare", "js", "en");
t.add("course.live_replay.share_tip", "Please confirm to share this live playback to the shared live playback resource library?", "js", "en");
t.add("course.live_replay.un_share_tip", "Please confirm to remove this live playback from the shared live playback library\uff1f", "js", "en");
t.add("course.live_replay.delete_tip", "Please confirm to remove this live playback\uff1f", "js", "en");
t.add("course.homework.score.tip1", "Please enter the passing score", "js", "en");
t.add("course.homework.score.tip2", "Please enter a value not greater than the total score of the test paper", "js", "en");
t.add("course.scoer.validator", "Please check the question score setting, there is a question setting error", "js", "en");
t.add("course.miss_score.validator", "The missed points shall not exceed the question points", "js", "en");
t.add("course.option_score.validator", "The total number of choices must not exceed the question mark", "js", "en");
t.add("testpaper.scoer.validator", "Please check the score setting of each question type, there are questions setting errors", "js", "en");
t.add("testpaper.option_score.validator", "The value of each item shall not exceed the value of each item", "js", "en");
t.add("all", "All", "js", "en");
t.add("coupon", "Coupon", "js", "en");
t.add("collar_roll", "Collar roll", "js", "en");
t.add("available_range", "Available range", "js", "en");
t.add("upload_image", "Upload image", "js", "en");
t.add("picture_cropping", "Picture cropping", "js", "en");
t.add("classroom_course_num", "Total <span>%courseNum%<\/span> courses", "js", "en");
t.add("all_products", "All products", "js", "en");
t.add("designated_goods", "Designated goods", "js", "en");
t.add("designated_member", "Designated member", "js", "en");
t.add("all_courses", "All courses", "js", "en");
t.add("all_classes", "All classes", "js", "en");
t.add("all_members", "All members", "js", "en");
t.add("some_products", "Some products", "js", "en");
t.add("ad_pictures", "Ad pictures", "js", "en");
t.add("carousel", "Carousel", "js", "en");
t.add("members_only", "Members Only", "js", "en");
t.add("free_classroom_course_num", "%courseNum% courses\uff0c %classroomNum% classes", "js", "en");
t.add("app.footer.find", "Find", "js", "en");
t.add("app.footer.learn", "Learn", "js", "en");
t.add("app.footer.dynamic", "Dynamic", "js", "en");
t.add("app.footer.mine", "Mine", "js", "en");
t.add("app.header.school_name", "School name", "js", "en");
t.add("app.header.search", "Search", "js", "en");
t.add("classification_class", "Classification class", "js", "en");
t.add("free_lesson", "Free lesson", "js", "en");
t.add("popular_class", "Popular class", "js", "en");
...
t.add("decorate.list_name", "List name", "js", "en");
t.add("decorate.please_enter_the_name_of_the_list", "Please enter the name of the list", "js", "en");
t.add("decorate.arrangement", "Arrangement", "js", "en");
t.add("decorate.row_by_column", "Row by column", "js", "en");
t.add("decorate.one_row_and_two_columns", "One row and two columns", "js", "en");
t.add("decorate.class_source", "Class source", "js", "en");
t.add("decorate.class_classification", "Class", "js", "en");
t.add("decorate.customize", "Customize", "js", "en");
t.add("decorate.select_class", "Select class", "js", "en");
t.add("decorate.order", "Order", "js", "en");
t.add("decorate.order2", "Order\uff1a", "js", "en");
t.add("decorate.join_the_most", "Join the most", "js", "en");
t.add("decorate.recently_created", "Recently created", "js", "en");
t.add("decorate.highest_rated", "Highest rated", "js", "en");
t.add("decorate.recommended_class", "Recommended class", "js", "en");
t.add("decorate.last_7_days", "Last 7 days", "js", "en");
t.add("decorate.last_30_days", "Last 30 days", "js", "en");
t.add("decorate.last_90_days", "Last 90 days", "js", "en");
t.add("decorate.history", "History", "js", "en");
t.add("decorate.display_number", "Display number", "js", "en");
t.add("decorate.show_only_published_classes", "Show only published classes", "js", "en");
t.add("decorate.remove", "Remove", "js", "en");
t.add("decorate.class_name", "Class name", "js", "en");
t.add("decorate.commodity_price", "Commodity price", "js", "en");
t.add("decorate.amount_of_goods", "Amount of goods", "js", "en");
t.add("decorate.creation_time", "Creation time", "js", "en");
t.add("decorate.operate", "Operate", "js", "en");
t.add("decorate.search_class", "Search class", "js", "en");
t.add("decorate.coupon", "Coupon", "js", "en");
t.add("decorate.only_show_coupons_no_expired", "Only show coupons that have not expired", "js", "en");
t.add("decorate.title", "Title", "js", "en");
t.add("decorate.show", "Show", "js", "en");
t.add("decorate.do_not_show", "Do not show", "js", "en");
t.add("decorate.coupon_selection", "Coupon selection", "js", "en");
t.add("decorate.add_coupon", "Add coupon", "js", "en");
t.add("decorate.choose_a_coupon", "Choose a coupon", "js", "en");
t.add("decorate.search_for_coupons", "Search for coupons", "js", "en");
t.add("decorate.coupon_name", "Coupon name", "js", "en");
t.add("decorate.prefix", "Prefix", "js", "en");
t.add("decorate.offer_content", "Offer content", "js", "en");
t.add("decorate.discount", "Discount", "js", "en");
t.add("decorate.trade_in", "Trade in", "js", "en");
t.add("decorate.valid_until", "Valid until", "js", "en");
t.add("decorate.remaining_total", "Remaining\/Total", "js", "en");
t.add("decorate.valid_within_fixed_day_of_receipt", "Valid within %fixedDay% day of receipt", "js", "en");
t.add("decorate.nknown_date", "Unknown date", "js", "en");
t.add("decorate.course_list_setting", "Course list setting", "js", "en");
t.add("decorate.course_source", "Course source", "js", "en");
t.add("decorate.course_sorts", "Course", "js", "en");
t.add("decorate.choose_a_course", "Choose a course", "js", "en");
t.add("decorate.recommended_courses", "Recommended courses", "js", "en");
t.add("decorate.show_only_published_courses", "Show only published courses", "js", "en");
t.add("decorate.course_title", "Course Title", "js", "en");
t.add("decorate.search_course", "Search course", "js", "en");
t.add("decorate.graphic_navigation_settings", "Graphic navigation settings", "js", "en");
t.add("decorate.add_graphic_navigation", "Add graphic navigation", "js", "en");
t.add("decorate.not_less_than", "Not less than 1", "js", "en");
t.add("decorate.change_picture", "Change picture", "js", "en");
t.add("decorate.please_enter_a_title", "Please enter a title", "js", "en");
t.add("decorate.link_source", "Link source", "js", "en");
t.add("decorate.please_choose", "Please choose", "js", "en");
t.add("decorate.members_only", "Members Only", "js", "en");
t.add("decorate.open_class_classification", "Open class", "js", "en");
t.add("decorate.select_image", "Select Image", "js", "en");
t.add("decorate.title2", "Title", "js", "en");
t.add("decorate.question_bank_list_settings", "Question bank list settings", "js", "en");
t.add("decorate.question_bank_classification", "Question bank classification", "js", "en");
t.add("decorate.basic", "Basic", "js", "en");
t.add("decorate.carousel", "Carousel", "js", "en");
t.add("decorate.graphic_navigation", "Graphic Navigation", "js", "en");
t.add("decorate.image_ad", "Image ad", "js", "en");
t.add("decorate.curriculum_schedule", "Curriculum schedule", "js", "en");
t.add("decorate.class_list", "Class list", "js", "en");
t.add("decorate.question_bank_list", "Question bank list", "js", "en");
t.add("decorate.open_class_list", "Open class list", "js", "en");
t.add("decorate.marketing", "Marketing", "js", "en");
t.add("decorate.all", "All", "js", "en");
t.add("decorate.open_class_list_settings", "Open class list settings", "js", "en");
t.add("decorate.choose_an_open_class", "Choose an open class", "js", "en");
t.add("decorate.only_show_published_public_classes", "Only show published public classes", "js", "en");
t.add("decorate.search_for_public_classes", "Search for public classes", "js", "en");
t.add("decorate.image_ad_settings", "Image ad settings", "js", "en");
t.add("decorate.add_pictures", "Add pictures", "js", "en");
t.add("decorate.select_link", "Select link", "js", "en");
t.add("decorate.select_member", "Select member", "js", "en");
t.add("decorate.custom_link", "Custom link", "js", "en");
t.add("decorate.mobile_phone_screen", "Adaptive mobile phone screen", "js", "en");
t.add("decorate.turn_on", "Turn on", "js", "en");
t.add("decorate.closure", "Closure", "js", "en");
t.add("decorate.revise", "Revise", "js", "en");
t.add("decorate.add_content", "Add content", "js", "en");
t.add("decorate.carousel_tip1", "The recommended image size is 686x272px, supports jpg\/png\/gif format, and the size does not exceed 2MB", "js", "en");
t.add("decorate.carousel_tip2", "Add up to 5 pictures, drag the selected pictures to sort them", "js", "en");
t.add("decorate.site_link", "Site link", "js", "en");
t.add("decorate.low_to_hign", "Low to high", "js", "en");
t.add("decorate.hign_to_low", "High to low", "js", "en");
t.add("decorate.choose", "Choose", "js", "en");
t.add("decorate.link_address", "Link address", "js", "en");
t.add("decorate.please_enter_the_link_address", "Please enter the link address", "js", "en");
t.add("decorate.link_wrong", "The link is wrong, please start with http:\/\/ or https:\/\/", "js", "en");
t.add("decorate.are_you_sure_exiting_editing", "Are you sure to exit editing?", "js", "en");
...
t.add("scrm.go_to_scrm", "Go to Scrm", "js", "en");
t.add("scrm.open_now", "Open now", "js", "en");
t.add("scrm.product_features", "Product features", "js", "en");
t.add("scrm.open_edusoho_scrm", "Open EduSoho Scrm", "js", "en");
t.add("scrm.hava_a_dedicated_business_manager", "Have a dedicated business manager or customer service for Kuozhi", "js", "en");
t.add("scrm.contact_your_business_manager", "Please contact your business manager or customer service to activate", "js", "en");
t.add("scrm.no_knowledgeable_business_manager", "No knowledgeable business manager or customer service", "js", "en");
t.add("scrm.please_scan_the_qr_code", "Please scan the QR code below to add a dedicated business manager to serve you", "js", "en");
t.add("scrm.note", "Note, Before opening EduSoho, you must first activate corporate WeChat", "js", "en");
t.add("scrm.to_open_corporate_wechat", "To open corporate WeChat", "js", "en");
t.add("scrm.attract_customers", "Attract customers and build a customer pool efficiently", "js", "en");
t.add("scrm.based_on_the_friend", "Based on the friend and community characteristics of enterprise WeChat, it provides flexible customer acquisition tools for education and training institutions, and helps training institutions to efficiently build customer pools.", "js", "en");
t.add("scrm.online_transaction_truly seamless", "Online transaction, truly seamless", "js", "en");
t.add("scrm.refined_marketing_management_improves_conversion_efficiency", "Refined marketing management improves conversion efficiency; after customers pass online transactions, they can automatically open teaching platform accounts for training, truly seamless connection.", "js", "en");
t.add("scrm.fast_customer_follow_up_improve_efficiency", "Fast customer follow-up, improve efficiency", "js", "en");
t.add("scrm.functions_of_sending_information", "The functions of sending information and labeling attributes improve the customer's understanding of the product and employees' understanding of the customer, and quick reply, group messaging, standard speech library, etc. improve the efficiency of customer follow-up.", "js", "en");
t.add("scrm.customer_management", "Customer management, realizing the enterpriseization of customer resources", "js", "en");
t.add("scrm.view_the_overall_information", "View the overall information of corporate customers through the background, including basic customer information, friend relationships, group chat information, customer follow-up status, etc., to realize the corporateization of customer resources.", "js", "en");
t.add("scrm.sales_analysis_performance_status_at_a_glance", "Sales analysis, performance status at a glance", "js", "en");
t.add("scrm.analyze_the_overall_situation_of_the_company_is_marketing", "Analyze the overall situation of the company's marketing; when the sales are completed and the customer follows up, the administrator can also analyze the sales effects of the sales.", "js", "en");
t.add("scrm.live_open_class", "Live open class", "js", "en");
t.add("scrm.set_up_live_open_classes", "Institutions quickly set up live open classes, and students can purchase regular classes in the live room; students can invite friends to study in the live room to achieve fission.", "js", "en");
t.add("testpaper.import.tip", "The test paper is imported successfully, please adjust the test paper score on the current page. (Note: 'Each item' setting is added for multiple-choice and variable-choice questions, and 'Each blank' setting is added for fill-in-the-blank questions.)", "js", "en");
t.add("admin.system.purchase_agreement_setting", "Purchase Agreement Settings", "js", "en");
t.add("admin.system.purchase_agreement", "Purchase agreement", "js", "en");
t.add("admin.system.purchase_agreement.title", "Title", "js", "en");
t.add("admin.system.purchase_agreement.content", "Content", "js", "en");
t.add("admin.system.purchase_agreement.style_settings", "Style settings", "js", "en");
t.add("admin.system.purchase_agreement.check_to_confirm", "Check to confirm", "js", "en");
t.add("admin.system.purchase_agreement.popup_confirmation", "Popup confirmation", "js", "en");
t.add("admin.system.purchase_agreement.see_details", "See details", "js", "en");
t.add("admin.system.purchase_agreement.submit", "Submit", "js", "en");
t.add("admin.system.purchase_agreement.content_empty", "Protocol content cannot be empty", "js", "en");
t.add("admin.system.purchase_agreement.saved_successfully", "Saved successfully!", "js", "en");
t.add("admin.system.purchase_agreement.save_failed", "Save failed!", "js", "en");
t.add("user_field.select_type.tip", "One per line, up to 20 characters per sub-item", "js", "en");
t.add("activity.summary", "summary", "js", "en");
t.add("activity.summary.placeholder", "Please enter the introduction (optional)", "js", "en");
...
t.add("question.bank.difficulty.simple", "Simple", "js", "en");
t.add("question.bank.difficulty.normal", "Normal", "js", "en");
t.add("question.bank.difficulty", "Hard", "js", "en");
t.add("question.bank.reset.btn", "Reset", "js", "en");
t.add("question.bank.check.tip", "Checking for duplicates...", "js", "en");
t.add("question.bank.check.result.category.noData", "No questions in this category.", "js", "en");
t.add("question.bank.check.result.noData", "No duplicate questions found.", "js", "en");
t.add("question.bank.check.result.noData.title", "No Duplicate Questions Found", "js", "en");
t.add("question.bank.check.result.noData.btn", "Back to List", "js", "en");
t.add("question.bank.all_question", "All Questions", "js", "en");
t.add("question.bank.no_category", "Uncategorized", "js", "en");
t.add("question.bank.common.repeated", "Number of duplicate questions", "js", "en");
t.add("question.bank.unit", "times", "js", "en");
t.add("question.bank.topic.comparison", "Question Comparison", "js", "en");
t.add("question.bank.next_label", "Next Step (1\/2)", "js", "en");
t.add("question.bank.skip_label", "Skip", "js", "en");
t.add("question.bank.finish_label", "Got it (2\/2)", "js", "en");
t.add("question.bank.check.guide.one", "<p class=\"title cd-dark-major\">Question Overview<\/p><div class=\"cd-dark-minor cd-text-md\">Displays the number of duplicate questions and the corresponding number of repetitions for each question.<\/div>", "js", "en");
t.add("question.bank.check.guide.two", "<p class=\"title cd-dark-major\">Question Comparison<\/p><div class=\"cd-dark-minor cd-text-md\">Click on the numerical button to switch between questions, which will be displayed in the preview area below.<\/div>", "js", "en");
t.add("question.bank.error.tip.title", "Question not found", "js", "en");
t.add("question.bank.error.tip.content", "The question may have been edited on the question management page.", "js", "en");
t.add("question.bank.type", "Type", "js", "en");
t.add("question.bank.update_time", "Update Date", "js", "en");
t.add("question.bank.none", "None", "js", "en");
t.add("question.bank.delete.tip.title", "Are you sure you want to delete this question?", "js", "en");
t.add("question.bank.delete.tip.content", "Deleting a question may affect the practice session of a lesson. Please proceed with caution!", "js", "en");
t.add("question.bank.head.edit", "Title editing", "js", "en");
t.add("question.bank.paper.status", "Status", "js", "en");
t.add("question.bank.paper.type", "Type", "js", "en");
t.add("question.bank.paper.generating", "Generating", "js", "en");
t.add("question.bank.paper.draft", "Draft", "js", "en");
t.add("question.bank.paper.fail", "Fail", "js", "en");
t.add("question.bank.paper.closed", "Closed", "js", "en");
t.add("question.bank.paper.published", "Published", "js", "en");
t.add("question.bank.paper.typeKeyword", "Input keywords", "js", "en");
t.add("question.bank.paper.name", "Name", "js", "en");
t.add("question.bank.paper.creator", "Creator", "js", "en");
t.add("question.bank.paper.regular", "Regular", "js", "en");
t.add("question.bank.paper.aiPersonality", "AI Personalized", "js", "en");
t.add("question.bank.paper.random", "Random", "js", "en");
...
t.add("question.bank.paper.pageTotal", "Total %total% items", "js", "en");
t.add("question.bank.paper.preview", "Preview", "js", "en");
t.add("question.bank.paper.close", "Close", "js", "en");
t.add("question.bank.paper.edit", "Edit", "js", "en");
t.add("question.bank.paper.publish", "Publish", "js", "en");
t.add("question.bank.paper.publish.success", "Successfully published", "js", "en");
t.add("question.bank.paper.close.success", "Successfully Closed", "js", "en");
t.add("question.bank.paper.batch.delete", "Batch Delete", "js", "en");
t.add("classroom.category.choose.text", "Please select a classroom category,", "js", "en");
t.add("course.category.choose.text", "Please select a course category,", "js", "en");
t.add("classroom.services.choose.train", "Practice,", "js", "en");
t.add("classroom.services.choose.try", "Tryout,", "js", "en");
t.add("classroom.services.choose.ask", "Ask,", "js", "en");
t.add("classroom.services.choose.suspected", "Inquiry,", "js", "en");
t.add("classroom.services.choose.dynamic", "Activity,", "js", "en");
t.add("classroom.services.choose.industry", "Industry,", "js", "en");
t.add("classroom.vip.category.text", "VIP Classroom,", "js", "en");
t.add("course.vip.category.text", "VIP Course,", "js", "en");
t.add("course.live", "Live Course,", "js", "en");
t.add("course.appointment", "Appointment Course,", "js", "en");
t.add("course.try.look", "Preview,", "js", "en");
t.add("certificate", "Certificate", "js", "en");
...
t.add("course.market_setting.contract.mandatory_signature", "Forced signature", "js", "en");
t.add("course.market_setting.contract.mandatory_signature.tip", "After compulsory signing is enabled, students can only learn after signing the contract. For those who have not signed the contract, a pop-up prompts them to sign the contract every time they enter the learning page.", "js", "en");
t.add("course.market_setting.contract.model.contractNumber", "Contract number", "js", "en");
t.add("course.market_setting.contract.model.contractSigning", "%name%-Contract signing", "js", "en");
t.add("course.market_setting.contract.model.partyA", "Party A", "js", "en");
t.add("course.market_setting.contract.model.signingDate", "Signing date", "js", "en");
t.add("course.market_setting.contract.model.partyB", "Party B", "js", "en");
t.add("course.market_setting.contract.model.handSignature", "Hand signature", "js", "en");
...
t.add("tab.course_tab.index.my_courses", "My Courses", "js", "en");
t.add("tab.course_tab.index.enter_course_name", "Please enter the course name", "js", "en");
t.add("tab.course_tab.index.live_class_schedule", "Live class schedule", "js", "en");
t.add("tab.course_tab.index.learning", "Learning", "js", "en");
t.add("tab.course_tab.index.have_completed", "Have completed studying", "js", "en");
t.add("tab.course_tab.index.have_expired", "Have expired", "js", "en");
t.add("tab.course_tab.index.collect", "Collect", "js", "en");
t.add("tab.course_tab.course_list.empty", "No courses available for the moment", "js", "en");
t.add("tab.course_tab.course_item.learning_progress", "Learning progress", "js", "en");
t.add("tab.course_tab.course_item.last_time_learned", "Last time learned\uff1a Class period", "js", "en");
t.add("tab.course_tab.course_item.closed", "Closed", "js", "en");
t.add("tab.course_tab.course_item.live_streaming", "Live streaming", "js", "en");
t.add("tab.course_tab.course_item.view_course", "View the course", "js", "en");
t.add("tab.course_tab.course_item.start_studying", "Start studying", "js", "en");
t.add("tab.classroom_tab.index.my_class", "My class", "js", "en");
t.add("tab.classroom_tab.index.enter_class_name", "Please enter the class name", "js", "en");
t.add("tab.classroom_tab.classroom_list.have_learned", "Have learned for %days% day", "js", "en");
t.add("tab.classroom_tab.classroom_item.learning_progress", "Progress", "js", "en");
t.add("tab.classroom_tab.classroom_tab.closed", "Closed", "js", "en");
t.add("tab.classroom_tab.classroom_tab.view_class", "View the class", "js", "en");
t.add("tab.classroom_tab.classroom_tab.continue_learning", "Continue", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.course_mistakes", "Course mistakes", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.classroom_mistakes", "Classroom mistakes", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.quiz_mistakes", "Quiz mistakes", "js", "en");
t.add("my.learning.wrong_question_book.detail.course.search_placeholder", "Please enter the course name", "js", "en");
t.add("my.learning.wrong_question_book.detail.list_item.problem", "questions", "js", "en");
t.add("my.learning.wrong_question_book.detail.list_item.check", "Check", "js", "en");
t.add("my.learning.wrong_question_book.detail.classroom.search_placeholder", "Please enter the classroom name", "js", "en");
t.add("my.learning.wrong_question_book.detail.item_bank.search_placeholder", "Please enter the name of the practice question bank", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.practice_of_incorrect_answers", "Practice of Incorrect Answers", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.modal.title", "Practice of Incorrect Answers", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.modal.ok_text", "Start answering the questions", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.modal.cancel_text", "Cancel", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.modal.display_quantity", "Display quantity", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.modal.questions", "questions", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.modal.custom", "Custom", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.modal.tip", "Input range: 1 \u2264 Number of questions \u2264 Total number of incorrect questions in a single error logbook", "js", "en");
t.add("my.learning.wrong_question_book.detail.index.message.warning.zero", "The number of answers cannot be zero", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.empty", "No data", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.entire_plan", "The entire plan", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.source", "Source of the question", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.task_name", "Task name", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.select_option.mistakes_frequency", "Frequency of mistakes", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.select_option.desc", "DESC", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.select_option.asc", "ASC", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.search", "Search", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.sources.exam_task", "Exam task", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.sources.job_task", "Job task", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.course.sources.practice_task", "Practice task", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.empty", "No data", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.all_courses", "All courses", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.source", "Source of the question", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.task_name", "Task name", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.select_option.mistakes_frequency", "Frequency of mistakes", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.select_option.desc", "DESC", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.select_option.asc", "ASC", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.search", "Search", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.sources.exam_task", "Exam task", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.sources.job_task", "Job task", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.classroom.sources.practice_task", "Practice task", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.question_bank.empty", "No data", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.question_bank.all_papers", "All the examination papers", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.question_bank.all_chapters", "All chapters", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.question_bank.select_option.mistakes_frequency", "Frequency of mistakes", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.question_bank.select_option.desc", "DESC", "js", "en");
t.add("my.learning.wrong_question_book.detail.screen.question_bank.select_option.asc", "ASC", "js", "en");
...
t.add("components.wrong_question.question_element.answer_result.answering_result", "Answering result", "js", "en");
t.add("components.wrong_question.question_element.analysis.analysis", "Analysis", "js", "en");
t.add("components.wrong_question.question_element.analysis.no_explanation", "No explanation", "js", "en");
t.add("components.wrong_question.question_element.situation.source", "Source", "js", "en");
t.add("components.wrong_question.question_element.situation.mistakes_frequency", "Frequency of mistakes", "js", "en");
t.add("components.wrong_question.question_element.situation.incorrect_questions", "Time spent on incorrect questions", "js", "en");
t.add("components.wrong_question.question_element.situation.times", "times", "js", "en");
t.add("components.wrong_question.question_element.answer_result.correct", "Correct", "js", "en");
t.add("components.wrong_question.question_element.answer_result.mistake", "Error", "js", "en");
t.add("components.wrong_question.question_element.right_answer.right_answers", "Right answers", "js", "en");
t.add("components.wrong_question.question_element.answer_result.gap_filling", "Gap filling", "js", "en");
t.add("components.wrong_question.question_element.right_answer.your_answer", "Your answer", "js", "en");
t.add("components.wrong_question.question_element.right_answer.not_answered", "Not answered", "js", "en");
t.add("components.wrong_question.question_element.right_answer.your_answer_is", "Your answer is", "js", "en");
t.add("components.wrong_question.question_element.right_answer.answered_incorrectly", "You answered incorrectly.", "js", "en");
})(Translator);
