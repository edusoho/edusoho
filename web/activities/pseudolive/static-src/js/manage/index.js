...
import { chooserUiOpen,chooserUiClose } from 'app/js/activity-manage/widget/chooser-ui';
...
export default class Live {
  ...
  initStep2Form() {
    jQuery.validator.addMethod('show_overlap_time_error', function(value, element) {
      return this.optional( element ) || !$('#length').data('showError');
    }, '所选时间已经有直播了，请换个时间');
  ...
  initEvent() {
    ...
    this.$form.on('click', '.js-choose-trigger', () => {
      $('.js-live-file-chooser').removeClass('hidden');
      $('.js-live-file-chooser-bar').remove();
    });
