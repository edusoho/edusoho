...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	    ...
	    var options = {
	        ...
	        display = 'html',
	        // to be used as $el.html in case of div and $el.val in case of input type text
	    ...
	    function secondsToTime(sec, timer) {
	        ...
	        if (timer.options.format) {
	            var formatDef = [{ identifier: '%h', value: timeObj.hours, pad: false }, { identifier: '%m', value: timeObj.minutes, pad: false }, { identifier: '%s', value: timeObj.seconds, pad: false }, { identifier: '%H', value: parseInt(timeObj.hours), pad: true }, { identifier: '%M', value: parseInt(timeObj.minutes), pad: true }, { identifier: '%S', value: parseInt(timeObj.seconds), pad: true }];
	            time = timer.options.format;
	
	            formatDef.forEach(function (format) {
	                time = time.replace(new RegExp(format.identifier.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, '\\$1'), 'g'), format.pad ? format.value < 10 ? '0' + format.value : format.value : format.value);
	            });
	        } else {
	            if (timeObj.hours) {
	    ...
	    // TIMER PROTOTYPE
	    var Timer = function Timer(element, userOptions) {
	        var elementType;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__("25615e536966c6acfa0b");


/***/ })

/******/ });
//# sourceMappingURL=jquery-timer.js.map