webpackJsonp(["app/js/weixin-share/index"],{
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _weixinJsSdk = __webpack_require__("50388ab3fa26698d3567");
	
	var _weixinJsSdk2 = _interopRequireDefault(_weixinJsSdk);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
	
	var $jweixin = $(".jweixin-data");
	
	_weixinJsSdk2["default"].config($jweixin.data('config'));
	...
	_weixinJsSdk2["default"].ready(function () {
	  ...
	  //分享到QQ
	  _weixinJsSdk2["default"].onMenuShareQQ({
	    title: $jweixin.data('title'),
	  ...
	  //分享到QQ空间
	  _weixinJsSdk2["default"].onMenuShareQZone({
	    title: $jweixin.data('title'),
	    desc: $jweixin.data('desc'),
	    link: $jweixin.data('link'),
	    imgUrl: $jweixin.data('imgUrl')
