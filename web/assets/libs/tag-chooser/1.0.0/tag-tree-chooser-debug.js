define("tag-chooser/1.0.0/tag-tree-chooser-debug", ["jquery"], function(require, exports, module) {
  // define(function(require, exports, module) {
  var $ = require('jquery');
  require("ztree/3.5.16/js/jquery.ztree.all-3.5-debug")($);
  var TagChooser = require("tag-chooser/1.0.0/tag-chooser-debug");
  var TagTreeChooser = TagChooser.extend({
    ...
    _initTree: function() {
      var self = this;
      this.$('[data-role=tags-list]').append('<ul class="tags-tree ztree" id="tags-tree-' + this.cid + '"></ul>');
      var setting = {
        view: {
          showLine: true,
          showIcon: false
...
define("tag-chooser/1.0.0/tag-chooser-debug", ["jquery"], function(require, exports, module) {
  // define(function(require, exports, module) {
