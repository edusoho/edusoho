define("gallery2/video-js/4.0.4/video-js-debug", [], function(require, exports, module) {
    /**
 ...
 */
    ...
    vjs.Player.prototype.getTagSettings = function(tag) {
        ...
        if (tag.hasChildNodes()) {
            var child, childName, children = tag.childNodes, i = 0, j = children.length;
            for (;i < j; i++) {
                child = children[i];
 ...
 */
    ...
    vjs.Player.prototype.buffered = function() {
        var buffered = this.techGet("buffered"), start = 0, // Default end to 0 and store in values
    ...
    vjs.ControlBar = vjs.Component.extend({
        ...
        init: function(player, options) {
            ...
            player.one("play", vjs.bind(this, function() {
                var touchstart, fadeIn = vjs.bind(this, this.fadeIn), fadeOut = vjs.bind(this, this.fadeOut);
                this.fadeIn();
 ...
 */
    ...
    vjs.DurationDisplay.prototype.updateContent = function() {
        if (this.player_.duration()) {
            this.content.innerHTML = '<span class="vjs-control-text">Duration Time </span>' + vjs.formatTime(this.player_.duration());
        }
    };
    /**
