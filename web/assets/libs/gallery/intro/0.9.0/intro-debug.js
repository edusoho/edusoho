define("gallery/intro/0.9.0/intro-debug", ['./intro.css'], function(require, exports, module) {
    require('./intro.css');
/**
 * Intro.js v0.9.0
...
(function(root, factory) {
    if (typeof exports === "object") {
        ...
        define("gallery/intro/0.9.0/intro-debug", [], factory);
    } else {
        // Browser globals
        factory(root);
    }
    ...
    function _showElement(targetElement) {
        ...
        if (oldHelperLayer != null) {
            var oldHelperNumberLayer = oldHelperLayer.querySelector(".introjs-helperNumberLayer"), oldtooltipLayer = oldHelperLayer.querySelector(".introjs-tooltiptext"), oldArrowLayer = oldHelperLayer.querySelector(".introjs-arrow"), oldtooltipContainer = oldHelperLayer.querySelector(".introjs-tooltip"), skipTooltipButton = oldHelperLayer.querySelector(".introjs-skipbutton"), prevTooltipButton = oldHelperLayer.querySelector(".introjs-prevbutton"), nextTooltipButton = oldHelperLayer.querySelector(".introjs-nextbutton");
            //hide the tooltip
            ...
            var helperLayer = document.createElement("div"), arrowLayer = document.createElement("div"), tooltipLayer = document.createElement("div"), tooltipTextLayer = document.createElement("div"), bulletsLayer = document.createElement("div"), buttonsLayer = document.createElement("div");
