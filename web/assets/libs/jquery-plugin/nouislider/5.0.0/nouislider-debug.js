define("jquery-plugin/nouislider/5.0.0/nouislider-debug", [ "$-debug" ], function(require) {
	...
	*/
    ...
    (function($) {
        ...
        $.fn["noUiSlider"] = function(options, rebuild) {
            ...
            doc = $(document), body = $("body"), namespace = ".nui", $VAL = $.fn.val, clsList = [ /*  0 */
            "noUi-base", "noUi-origin", "noUi-handle", "noUi-input", "noUi-active", "noUi-state-tap", "noUi-target", "-lower", "-upper", "noUi-connect", "noUi-horizontal", "noUi-vertical", "noUi-background", "noUi-stacking", "noUi-block", "noUi-state-blocked", "noUi-ltr", "noUi-rtl", "noUi-dragable", "noUi-extended", "noUi-state-drag" ], actions = window.navigator["pointerEnabled"] ? {
                start: "pointerdown",
                move: "pointermove",
                end: "pointerup"
            ...
            function setHandle(handle, to) {
                var base = handle.data("base"), settings = base.data("options"), handles = base.data("handles"), lower = 0, upper = 100;
            ...
            function setValue(args, set) {
                ...
                return this.each(function() {
                    var b = $(this).data("base"), to, i, handles = Array.prototype.slice.call(b.data("handles"), 0), settings = b.data("options");
            ...
            function build(options) {
                ...
                return this.each(function() {
                    ...
                    var values = $(this).val() || false, current = $(this).data("options"), // Extend the current setup with the new options.
