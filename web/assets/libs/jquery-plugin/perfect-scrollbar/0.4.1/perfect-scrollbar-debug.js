define("jquery-plugin/perfect-scrollbar/0.4.1/perfect-scrollbar-debug", [ "$-debug", "jquery-plugin/mousewheel/3.1.3/mousewheel-debug" ], function(require) {
    ...
    (function($) {
        ...
        $.fn.perfectScrollbar = function(suppliedSettings, option) {
            return this.each(function() {
                ...
                var $this = $(this).addClass("ps-container"), $scrollbarX = $("<div class='ps-scrollbar-x'></div>").appendTo($this), $scrollbarY = $("<div class='ps-scrollbar-y'></div>").appendTo($this), containerWidth, containerHeight, contentWidth, contentHeight, scrollbarXWidth, scrollbarXLeft, scrollbarXBottom = parseInt($scrollbarX.css("bottom"), 10), scrollbarYHeight, scrollbarYTop, scrollbarYRight = parseInt($scrollbarY.css("right"), 10);
