define("jquery-plugin/nicescroll/3.5.4/nicescroll-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    /* jquery.nicescroll
-- version 3.4.0
...
*/
    (function(jQuery) {
        ...
        var tabindexcounter = 5e3;
        var ascrailcounter = 2e3;
