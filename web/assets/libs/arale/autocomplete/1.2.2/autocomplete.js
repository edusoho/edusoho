define("arale/autocomplete/1.2.2/autocomplete", ["$", "arale/overlay/1.1.1/overlay", "arale/position/1.0.1/position", "arale/iframe-shim/1.0.2/iframe-shim", "arale/widget/1.1.1/widget", "arale/base/1.1.1/base", "arale/class/1.1.0/class", "arale/events/1.1.0/events", "arale/templatable/0.9.1/templatable", "gallery/handlebars/1.0.2/handlebars", "./data-source", "./filter", "./autocomplete.handlebars"], function (a, b, c) {
    function d(a) {
    ...
    function f(a, b) {
        var c = this.highlightIndex, d = 0, e = b || this.matchKey || "", f = "";
        if (g.isArray(c)) {
    ...
    var g = a("$"), h = a("arale/overlay/1.1.1/overlay"), i = a("arale/templatable/0.9.1/templatable"), j = a("./data-source"), k = a("./filter"), l = a("./autocomplete.handlebars"), m = -1 !== (window.navigator.userAgent || "").toLowerCase().indexOf("msie"), n = {
        UP: 38,
        DOWN: 40,
        LEFT: 37,
        RIGHT: 39,
        ...
        Implements: i, attrs: {
        ...
        }, templateHelpers: {highlightItem: f}, parseElement: function () {
            this.set("model", {classPrefix: this.get("classPrefix"), items: []}), o.superclass.parseElement.call(this)
        }, setup: function () {
            var a = this.get("trigger"), b = this;
            ...
            this.hide();
            var a = this.currentItem, b = this.get("selectedIndex"), c = this.get("data")[b];
            if (a) {
                var d = a.attr("data-value");
                this.get("trigger").val(d), this.set("inputValue", d, {silent: !0}), this.trigger("itemSelect", c), this._clear()
            }
            ...
            var b = this.get("filter"), c = this.get("locator");
            a = e(c, a), a = b.func.call(this, a, this.queryValue, b.options), this.set("data", a)
        }, _onRenderData: function (a) {
            this._clear(), this.set("model", {items: a}), this.renderPartial("[data-role=items]"), this.items = this.$("[data-role=items]").children(), this.currentItem = null, this.get("selectFirst") && this.set("selectedIndex", 0), g.trim(this.$("[data-role=items]").text()) ? this.show() : this.hide()
            ...
            a = void 0 === a ? "url" === this.dataSource.get("type") ? null : {
                ...
                func: k[a.name],
                options: a.options
            } : null : g.isFunction(a) ? {func: a} : k[a] ? {name: a, func: k[a]} : null, a || (a = {
                name: "default",
                func: k["default"]
            }), this.set("filter", a)
        }, _blurEvent: function () {
            ...
            var b = this.get("selectedIndex");
            -1 === a ? b > 0 ? this.set("selectedIndex", b - 1) : this.set("selectedIndex", this.items.length - 1) : 1 === a && (b < this.items.length - 1 ? this.set("selectedIndex", b + 1) : this.set("selectedIndex", 0))
        }, _clear: function () {
    ...
    var f = a("arale/base/1.1.1/base"), g = a("$"), h = f.extend({
        attrs: {source: null, type: "array"},
        initialize: function (a) {
            h.superclass.initialize.call(this, a), this.id = 0, this.callbacks = [];
            var b = this.get("source");
            if (d(b))this.set("type", "url"); else if (g.isArray(b))this.set("type", "array"); else if (g.isPlainObject(b))this.set("type", "object"); else {
        ...
        _getUrlData: function (a) {
            ...
            this.callbacks.push(f), b = /^(https?:\/\/)/.test(e) ? {dataType: "jsonp"} : {dataType: "json"}, g.ajax(e, b).success(function (a) {
        ...
        _getFunctionData: function (a) {
            ...
            var c = this, d = this.get("source"), e = d.call(this, a, b);
            e && this._done(e)
        }
    });
    c.exports = h
    ...
    var g = a("$"), h = {
        "default": function (a, b, c) {
            ...
            var e = [], h = b.length, i = new RegExp("^" + f(b));
            return h ? (g.each(a, function (a, b) {
                var f = {}, j = d(b, c);
                g.isPlainObject(b) && (f = g.extend({}, b)), i.test(j) && (f.matchKey = j, h > 0 && (f.highlightIndex = [[0, h]]), e.push(f))
            }), e) : []
    ...
    var d = a("gallery/handlebars/1.0.2/runtime"), e = d.template;
