...
// (function () {
//     function addpicDialog(editor) {
//         var isIE=!-[1,];
//         if (isIE) {
//             html='<div class="formulaOld" style="width:750px;height:350px;"><div class="tips" style="color:red;line-height:40px;">请升级您的浏览器到IE9版本及以上版本，或使用chrome浏览器使用可视化公式编辑器</div><textarea id="oldaddpic" style="width:100%;height:240px;border:1px solid #ccc;"></textarea></div>';
//         }
//         html = '<iframe scrolling="no" id="editorContainer_'+editor.name+'" src="/assets/libs/ckeditor/4.6.7/plugins/addpic/index.html" width="780" height="500"></iframe>';
...
//             // swf文件路径
//             swf: 'http://192.168.90.162' +'assets/libs/webuploader/Uploader.swf',
...
//     CKEDITOR.dialog.add('addpic', function (editor) {
//         return addpicDialog(editor);
//     });
// })();
