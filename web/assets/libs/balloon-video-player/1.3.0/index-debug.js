define("balloon-video-player/1.3.0/index-debug", [], function(require, exports, module){
require("balloon-video-player/1.3.0/src/video-js/video.dev-debug");
videojs.options.flash.swf = require.resolve("./src/video-js/video-js.swf#");
require("balloon-video-player/1.3.0/src/video-js/lang/zh-CN-debug");
require("balloon-video-player/1.3.0/src/plugins/fingerprint/fingerprint-debug");
require("balloon-video-player/1.3.0/src/plugins/quality-selector/video-quality-selector-debug");
require("balloon-video-player/1.3.0/src/plugins/watermark/watermark-debug");
require("balloon-video-player/1.3.0/src/plugins/marker/marker-debug");
require("balloon-video-player/1.3.0/src/plugins/pluck/pluck-debug");
require("balloon-video-player/1.3.0/src/plugins/hotkeys/hotkeys-debug");
require("balloon-video-player/1.3.0/src/plugins/progressTips/progressTips-debug");

});
define("balloon-video-player/1.3.0/src/video-js/video.dev-debug", [], function(require, exports, module){
/**
...
define("balloon-video-player/1.3.0/src/video-js/lang/zh-CN-debug", [], function(require, exports, module){
...
define("balloon-video-player/1.3.0/src/plugins/fingerprint/fingerprint-debug", [], function(require, exports, module){
videojs.plugin('fingerprint', function(options) {
    ...
    el.className = 'vjs-fingerprint';
    el.innerHTML = settings.html;
    el.onselectstart = el.ondrag = function() {
        return false;
    }
    ...
    var showFingerprint = function () {
        if (running) {
            refreshFingerprintPosition(player, el);
    ...
    var refreshFingerprintPosition = function (player, el) {
        var left = parseInt(player.el().offsetWidth * Math.random());
        if (left + el.offsetWidth > player.el().offsetWidth) {
            left = player.el().offsetWidth - el.offsetWidth;
        }

        var top = parseInt(player.el().offsetHeight * Math.random());
        if (top + el.offsetHeight > player.el().offsetHeight) {
            top = player.el().offsetHeight - el.offsetHeight;
        }
...
define("balloon-video-player/1.3.0/src/plugins/quality-selector/video-quality-selector-debug", [], function(require, exports, module){
/**
...
define("balloon-video-player/1.3.0/src/plugins/watermark/watermark-debug", [], function(require, exports, module){
(function() {
  var defaults = {
...
define("balloon-video-player/1.3.0/src/plugins/marker/marker-debug", [], function(require, exports, module){
(function() {
   //default setting
   var defaultSetting = {
      markerStyle: {
...
define("balloon-video-player/1.3.0/src/plugins/hotkeys/hotkeys-debug", [], function(require, exports, module){
/*
 * Video.js Hotkeys
...
define("balloon-video-player/1.3.0/src/plugins/progressTips/progressTips-debug", [], function(require, exports, module){
