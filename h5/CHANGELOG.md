### 1.0.36（2020-03-05） ES版本：v8.6.11
* [修复] yarn打包很多警告
* [修复] 分销插件引起的课程和班级页报错
* [修复] 课程列表页和vip课程列表页，减价显示成打折
* [修复] vip的更多课程和更多班级页面打不开

### 1.0.35（2020-03-02） ES版本：v8.6.10
* [新增] web后台可以配置公开课组件
* [新增] web后台可以配置图文导航组件
* [修复] web后台组件自定义数据时拖拽改变顺序后，数据丢失问题
* [新增] app的webview 公开课更多页面
* [新增] app的webview 课程、班级、公开课更多页面，直播课表，今日学习的下拉刷新功能

### 1.0.34（2020-02-26） ES版本：v8.6.8
* [修复] 打折活动文案 “5折” 显示成了 “折5”

### 1.0.33（2020-02-24） ES版本：v8.6.7
* [修复] 营销活动减500显示成了500折
* [修复] 在https请求下，提供给app的webview页面不可用

### 1.0.32（2020-02-07） ES版本：v8.6.5
* [新增] app的webview 课程、班级更多页面
* [新增] app的webview 直播课表、今日直播页面
* [新增] app的webview 历史学习页面

### 1.0.31（2020-01-03） ES版本：v8.6.2
* [优化] 班级封面比例图片比例更改为16:9 
* [修复] 	新版微网校无法更改头像
* [修复] 	新版微网校组件组件标记界面提示显示错位
* [修复] 	新版微网校优惠券显示及使用

### 1.0.30（2019-12-18） ES版本：v8.4.0
* [修复] 	课时下创建子任务后打不开课时问题

### 1.0.29（2019-12-05） ES版本：v8.4.0
* [修复] 部分情况下IOS端打开新版微网校时，下拉课时目录会闪屏
* [修复] 课程中默认计划中切换非默认计划时，非默认计划目录错乱
* [修复] 新版微网校购买会员提交购买会有一秒钟界面显示：您还不是会员
* [新增] App首页灵活配置

### 1.0.28（2019-11-21） ES版本：v8.3.51
* [修复] 我的页面，分销入口一闪而过
* [新增] vue脚手架从cli2升级到cli3

### 1.0.27（2019-10-31） ES版本：v8.3.49
* [新增] 新增分销推广功能，支持网校账号一键成为代理商，推广商品

### 1.0.26（2019-10-23） ES版本：v8.3.48
* [优化] 改善学习卡卡密输入体验
* [优化] 简化学习卡充值流程
* [优化] 未注册账号支持通过手机号快捷创建账号并快速充值学习卡


### 1.0.25（2019-10-14） ES版本：v8.3.47
* [新增] 支持多商品优惠券的领取和使用


### 1.0.24（2019-10-09） ES版本：v8.3.46
* [新增] 练习说明页。
* [新增] 练习答题功能。
* [新增] 练习答案本地缓存功能。
