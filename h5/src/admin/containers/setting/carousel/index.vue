<template>
  <module-frame
    ...
    container-class="setting-carousel"
  >
    <div
      slot="preview"
      :class="{ 'carousel-image-container__app': pathName === 'appSetting' }"
      class="carousel-image-container"
    >
      <img v-show="carouselImage" :src="carouselImage" class="carousel-image" />
      <div
...
export default {
  ...
  computed: {
    ...
    carouselImage() {
      return (
        this.copyModuleData.data[this.activeItemIndex] &&
