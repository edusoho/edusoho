export default {
  ...
  contract: {
    ...
    acrossScreen: 'Please rotate your screen horizontally to sign',
    signScope: 'Signature scope',
    signTips: 'Please ensure the "signature is clear" and try to fill the "signature scope"',
    clear: 'Clear',
    submit: 'Submit',
    ...
    signContractTitle: 'Sign electronic contract',
    signContractTips: 'Please sign the "{name}" before starting the learning to ensure normal access to subsequent services',
    sign: 'Go to sign',
