  ...
  <div class="vip-detail">
    ...
    <div class="user-section gray-border-bottom clearfix">
      <div v-if="user">
        ...
        <div class="user-middle">
          ...
          <span v-else class="user-vip">
            您还不是会员
          </span>
        </div>
        <div v-if="vipInfo" class="vip-status">
          <div v-if="btnStatus" ref="joinBtnTop" class="vip-status__btn" @click="popShow">{{ vipDated ? '重新开通' : btnStatus }}</div>
    ...
    <a v-if="isShowInviteUrl" :href="inviteUrl">
      <div class="coupon-code-entrance">邀请好友购买
        <i class="van-icon van-icon-arrow pull-right"/><i class="pull-right">赚 {{ drpSetting.minDirectRewardRatio }}%</i>
      </div>
    </a>
    ...
    <e-popup
      ...
      <div :class="{ disabled: activePriceIndex < 0 }" class="btn-join-bottom" @click="joinVip">确认{{ btnStatus }}</div>
    </e-popup>
