    ...
    <div class="essay">
      ...
      <div v-if="!disabledData" class="answer-paper">
        <div v-if="!disabledData" class="answer-paper">
          ...
          <div>
            <div v-if="mode === 'exam' && !canDo">
              ...
              <img
                ...
                alt=""
                class="fill-status">
              <span class="is-right-answer" v-if="(exerciseMode == '' &&  question.length > 0 && question[0].status === 'right') || (itemdata.testResult.status === 'right' && itemdata.testResult.status !== 'none')" v-html="answer[0]" @click="handleClickImage($event.target)"></span>
              <span class="is-wrong-answer" v-else-if="(question.length > 0 && question[0].status === 'wrong') || (itemdata.testResult.status === 'wrong') || (itemdata.testResult.status === 'noAnswer') || (itemdata.testResult.status === 'partRight')" v-html="answer[0]" @click="handleClickImage($event.target)"></span>
              <span v-if="itemdata.testResult.status === 'none'" class="your-answer" style="color: #37393D;" v-html="answer[0]" @click="handleClickImage($event.target)"></span>
            ...
            <div v-else>
              ...
              <span class="essay-answer" style="color: #37393D;" v-html="answer[0]" @click="handleClickImage($event.target)"></span>
            </div>
          </div>
          ...
          <div class="mb-16">
            <span class="is-right-answer" v-html="itemdata.answer[0]" @click="handleClickImage($event.target)" />
          </div>
