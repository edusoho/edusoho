<template>
  <div v-show="isFristVisited" class="guide" @click="isFristVisited=false">
...
export default {
  ...
  methods: {
    ...
    setVisited() {
      const localvisitedName = `${this.user.id}-task-visited`
      const isVisited = localStorage.getItem(localvisitedName)
