<template>
  <div class="join-after">
    ...
    <van-tabs id="tabs" ref="tabs" v-model="active" :class=" tabFixed ? 'isFixed' : '' ">
    ...
    <div class="join-after__content">
      <div v-show="active == 1">
        <div id="progress-bar" :class="['progress-bar', tabFixed ? 'progress-bar-fix' : '']">
      ...
      <!-- 学员评价 -->
      <div v-show="active == 2">
        <review-list ref="review" :target-id="details.courseSet.id" :reviews="details.reviews" title="学员评价" defaul-value="暂无评价" type="course"/>
      </div>
    </div>
  </div>
</template>
