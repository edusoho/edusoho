<template>
  <e-panel title="优惠">
    <!-- 拼团 -->
    <van-cell
      v-if="activities.groupon"
      class="course-detail__cell"
      is-link
      @click="activityHandle(activities.groupon.id)"
    >
      <template slot="title">
    ...
    <van-cell
      ...
      class="course-detail__cell"
      is-link
      @click="activityHandle(activities.cut.id)"
    >
      <template slot="title">
    ...
    >
      <template slot="title">
        ...
        <mini-coupon
          v-for="(item, index) in miniCoupons"
          :item="item"
          :key="index"
        />
      </template>
    ...
    <e-popup
      :show.sync="couponListShow"
      class="coupon-popup white-background"
      title="优惠券"
    >
      <coupon
