<template>
  <div class="e-learn">
    ...
    <emptyCourse v-if="active==0 && isEmptyCourse && isCourseFirstRequestCompile" :type="typeList"　text="暂无课程"/>
    <emptyCourse v-if="active==1 && isEmptyClass && isClassFirstRequestCompile" :type="typeList"　text="暂无班级"/>
    <emptyCourse v-if="active==2 && isEmptyBank && isBankFirstRequestCompile" :type="typeList" text="暂无题库"/>
    <div v-else>
      <lazyLoading
        v-show="active==0"
