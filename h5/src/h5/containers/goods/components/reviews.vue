<template>
  <div class="info-evaluate">
    <template v-if="reviews.length">
      <div
        class="info-evaluate__item clearfix"
      ...
      >
        ...
        <div class="pull-left evaluate-content">
          <div class="evaluate-content__name content-name clearfix">
            <span class="content-name__nickname pull-left">{{
              review.user.nickname
            }}</span>
            <span class="content-name__time pull-right">{{
          ...
          <div class="evaluate-content__text">{{ review.content }}</div>
        </div>
      </div>
    </template>
