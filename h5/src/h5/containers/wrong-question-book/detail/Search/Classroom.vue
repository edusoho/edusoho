<template>
  ...
  >
    ...
    <div class="search-checked">
      ...
      >
        <div class="checked-title">{{ $t(condition.title) }}</div>
...
export default {
  ...
  data() {
    return {
      ...
      conditions: [
        {
          title: 'wrongQuestion.courseName',
          placeholder: 'wrongQuestion.chooseName',
          columns: [],
          selectdText: 'wrongQuestion.chooseName',
          selectdIndex: 0,
        },
        {
  ...
  methods: {
    fetchCondition() {
      Api.getWrongQuestionCondition({
        ...
        const { courseSets, mediaTypes, tasks } = res;

        _.forEach(courseSets, item => {
        ...
        this.conditions[0].columns = courseSets;
        this.conditions[1].columns = newMdiaTypes;
    ...
    onClickReset() {
      ...
      this.conditions[0].selectdText = this.$t('wrongQuestion.chooseName');
