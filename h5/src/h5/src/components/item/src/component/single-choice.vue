    ...
    <div style="height: 100% !important">
      ...
      <div class="ibs-subject-material" v-if="currentItem.type === 'material'" >
        <div :class="['ibs-material-stem-nowrap', isShowDownIcon ? 'ibs-material-stem' : '']">
          ...
          <span :id="`current${currentItem.id}`" class="ibs-material-text ibs-material-icon" v-html="currentItem.material" @click="handleClickImage($event.target)"></span>
        </div>
        ...
        <div class="ibs-subject">
          ...
          >
            ...
            >
              ...
              <div class="ibs-subject-option__content" v-html="item.radio.text" @click="handleClickImage($event.target)"/>
              <template #icon="props">
                <span
                  :class="[
