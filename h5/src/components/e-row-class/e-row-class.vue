  ...
  <div class="e-row-class"
    ...
    <div class="relative row-class-left">
      ...
      <div class="relative z-1 h-full">
        ...
        <div v-if="course.hidePrice === '1' && Number(isVip)" class="absolute left-0 bottom-0 px-8 text-white text-12 font-medium bg-black bg-opacity-80 rounded-bl-6" style="padding-top: 2px; padding-bottom: 2px; line-height: 20px; border-top-right-radius: 12px; z-index: 10;">会员免费</div>
    ...
    <div class="row-class-right relative">
      ...
      <div class="row-class-right__top">
        <div v-if="course.hidePrice === '1' && discountNum" style="height:14px;margin: 3px 4px 0 0;text-align: center;line-height: 14px;border: 1px solid #ff900e;border-radius: 2px;">
