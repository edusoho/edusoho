<template>
  <div class="e-openCourse-class">
    ...
    <div class="openCourse-class-right">
      <div class="openCourse-class-right__top text-overflow">
        {{ course.title }}
      </div>
        ...
        <div class="openCourse-class-right__live">
          ...
          <div class="live-content__right">
            <div
              ...
              :class="[
                'live-btn',
                status === 'default' ? 'live-btn--start' : 'live-btn--default',
              ]"
              @click="toTask()"
            >
              {{ status | liveBtnText }}
...
export default {
  ...
  filters: {
    ...
    filterOpenCourse: function(value) {
      ...
      return `${formatChinaDay(startTimeStamp)} ${formatSimpleHour(
        startTimeStamp,
      )}`;
    },
  },
