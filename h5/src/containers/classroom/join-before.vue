<template>
  <div class="course-detail classroom-detail">
    <div class="join-before">
      ...
      <!-- 秒杀 -->
      <e-footer v-if="showSeckill && seckillStatus !== '已到期'" :disabled="!accessToJoin" :half="!!showSeckill && seckillStatus !== '已到期'" @click.native="handleJoin">{{details.access.code | filterJoinStatus('classroom', vipAccessToJoin)}}</e-footer>
