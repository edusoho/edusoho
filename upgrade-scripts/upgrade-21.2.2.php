...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function addBizQuestionCasSensitive()
    {
        $this->logger('info', "添加case_sensitive");

        if (!$this->isFieldExist('biz_question', 'case_sensitive')) {
            $this->getConnection()->exec("ALTER TABLE `biz_question` ADD COLUMN `case_sensitive` tinyint DEFAULT '1' COMMENT '填空题判题大小写敏感' AFTER answer_mode");
        }
