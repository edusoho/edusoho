...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function addBizQuestionFavoriteIndex()
    {
        if (!$this->isIndexExist('biz_question_favorite', 'user_id_and_target_type')) {
            $this->getConnection()->exec("ALTER TABLE `biz_question_favorite` ADD INDEX `user_id_and_target_type` (`user_id`, `target_type`);");
        }
        return 1;
    }
