...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function courseSetAddDiscountType()
    {
        if (!$this->isFieldExist('course_set_v8', 'discountType')) {
            $this->getConnection()->exec("
                ALTER TABLE `course_set_v8` ADD `discountType` varchar(64) NOT NULL DEFAULT 'discount' COMMENT '打折类型(discount:打折，reduce:减价)' AFTER `discountId`;
            ");
        }
