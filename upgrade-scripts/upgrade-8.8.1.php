...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function addFileGroupColumn()
    {
        $this->logger('info', 'file_group 添加 user_import');

        if(!$this->isFileGroupExist("user_import")){
            $this->getConnection()->exec("INSERT INTO `file_group` (`id`, `name`, `code`, `public`) VALUES (NULL, '用户导入', 'user_import', '0');");
        }
