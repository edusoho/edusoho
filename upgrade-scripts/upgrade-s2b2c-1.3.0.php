        ...
        foreach ($products as $product) {
            try{
                ...
                $this->getProductService()->updateProduct($product['id'], [
                    ...
                    'remoteVersion' => $distribute['content']['editVersion'],
                    's2b2cProductDetailId' => ($product['productType'] == 'course_set' ? $distribute['courseSetDetail']['id'] : $distribute['courseDetail']['id']),
                ]);
                echo "更新product执行成功 id#{$product['id']}";
