...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function alterS2B2CTable()
    {
        if (!$this->isFieldExist('s2b2c_product', 's2b2cProductDetailId')) {
            $this->getConnection()->exec("ALTER TABLE `s2b2c_product` ADD COLUMN `s2b2cProductDetailId` int(11) unsigned NOT NULL COMMENT '产品详情ID' AFTER `remoteProductId`;");
        }
