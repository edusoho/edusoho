...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    protected function dealClassroomTeachers()
    {
        $sql = "SELECT id, teacherIds from classroom;";
        $classrooms = $this->getConnection()->fetchAll($sql);
        if (empty($classrooms)) {
            return 1;
        }
        ...
        $this->logger('info', '更新classroom.teacherIds字段，共有'.count($classrooms).'条');
        return 1;
