...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function alterSignUserLogTable()
    {
        if ($this->isFieldExist('sign_user_log', 'rank')) {
            $this->getConnection()->exec("
                ALTER TABLE `sign_user_log` CHANGE `rank` `_rank` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '签到排名';
            ");
        }
        return 1;
    }
