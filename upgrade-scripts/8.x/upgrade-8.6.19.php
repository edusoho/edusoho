...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    private function updateScheme($index)
    {
        $definedFuncNames = array(
            'updateCourseTableCourseSetTitleLength',
        );
    ...
    public function updateCourseTableCourseSetTitleLength()
    {
        if ($this->isFieldExist('course_v8', 'courseSetTitle')) {
            $this->getConnection()->exec("ALTER TABLE `course_v8` modify COLUMN `courseSetTitle` varchar(1024) NOT NULL DEFAULT '' COMMENT '所属课程名称';");
        }
