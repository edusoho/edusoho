...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    protected function addUploadFilesColumn()
    {
        if (!$this->isFieldExist('upload_files', 'mp4ConvertStatus')) {
            $this->getConnection()->exec("ALTER TABLE `upload_files` ADD `mp4ConvertStatus` enum('none','waiting','doing','success','error') NOT NULL DEFAULT 'none' COMMENT '视频转mp4的状态';");
        }
        return 1;
    }

    public function alterBodyToLongtext()
    {
