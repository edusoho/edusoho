...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    {
        if (!$this->isFieldExist('testpaper_v8', 'questionTypeSeq')) {
            $this->getConnection()->exec("ALTER TABLE `testpaper_v8` ADD COLUMN `questionTypeSeq` varchar(64) NOT NULL DEFAULT '' COMMENT '题型排序' AFTER itemCount;");
        }
