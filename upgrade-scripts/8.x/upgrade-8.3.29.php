...
{
    private $classroomUpdateHelper = null;

    public function __construct($biz)
    {
        parent::__construct($biz);
        $this->classroomUpdateHelper = new BatchUpdateHelper($this->getClassroomDao());
    }
    ...
    protected function deleteOpenCourseChannelBlockTemplate()
    {
        $sql = "SELECT * FROM block_template WHERE title = '公开课频道 - 首页 - 头部轮播图';";
        $blockTemplate = $this->getConnection()->fetchAll($sql);
        ...
        $blockTemplateJson = json_encode($blockTemplate);
