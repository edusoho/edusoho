...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function createAccountDestroyTable()
    {
        ...
        if (!$this->isTableExist('destroyed_account')) {
            $this->getConnection()->exec("
        ...
        if (!$this->isFieldExist('user', 'destroyed')) {
            $this->getConnection()->exec("
                ALTER TABLE `user` ADD `destroyed` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '是否注销';
            ");
        }
