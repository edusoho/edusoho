...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function alterUserColumns()
    {
        if (!$this->isFieldExist('user', 'scrmUuid')) {
            $this->getConnection()->exec("ALTER TABLE `user` ADD COLUMN `scrmUuid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Scrm平台用户Uuid' AFTER uuid;");
        }
        return 1;
    }
