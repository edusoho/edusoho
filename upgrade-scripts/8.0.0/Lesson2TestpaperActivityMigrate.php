...
class Lesson2TestpaperActivityMigrate extends AbstractMigrate
{
    ...
    {
        $sql = "UPDATE activity_testpaper AS ta,(SELECT id,limitedTime,oldTestId FROM testpaper_v8) AS tmp SET ta.mediaId = tmp.id, ta.limitedTime = tmp.limitedTime WHERE tmp.migrateTestId = ta.mediaId";
