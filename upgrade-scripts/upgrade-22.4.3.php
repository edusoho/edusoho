...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function bizAnswerRecordAddIndex()
    {
        $this->createIndex('biz_answer_record', 'assessment_id', 'assessment_id');

        $this->logger('info', 'biz_answer_record新增索引assessment_id完成');

        return 1;
    }

    public function bizAnswerReportAddIndex()
    {
        $this->createIndex('biz_answer_report', 'assessment_id', 'assessment_id');

        $this->logger('info', 'biz_answer_report新增索引assessment_id完成');

        return 1;
    }

    public function bizAnswerQuestionReportAddIndex()
    {
