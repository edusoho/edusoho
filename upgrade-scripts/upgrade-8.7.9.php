...
class EduSohoUpgrade extends AbstractUpdater
{
    ...
    public function alterUserBind()
    {
        if ($this->isFieldExist('user_bind', 'fromId')) {
            $this->getConnection()->exec("ALTER TABLE `user_bind` modify COLUMN `fromId` varchar(64) NOT NULL COMMENT '来源方用户ID';");
        }
