...
namespace OpenLivePlugin\Common\Qiniu;

use OpenLivePlugin\Common\Qiniu\Config;

final class QiniuFunctions
{
     ...
     * @link http://www.php.net/manual/en/public static function.json-decode.php
     */
