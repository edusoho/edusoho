define(function(require, exports, module) {
  ...
  exports.run = function() {
    ...
    $exportBtns.on('click', function () {
      ...
      let keywordType = $('#enrollListKeywordType').val();
      let keyword = $('#enrollListKeyword').val();
      var preUrl = $exportBtn.data('preUrl') + '?keywordType=' + keywordType + '&keyword=' + keyword;
      var tryUrl = $exportBtn.data('tryUrl') + '?keywordType=' + keywordType + '&keyword=' + keyword;
