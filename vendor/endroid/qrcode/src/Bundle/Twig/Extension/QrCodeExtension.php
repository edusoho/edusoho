...
class QrCodeExtension extends \Twig_Extension implements \Symfony\Component\DependencyInjection\ContainerAwareInterface
{
    /**
    ...
    {
        return array(new \Twig_SimpleFunction('qrcode_url', array($this, 'qrcodeUrlFunction')), new \Twig_SimpleFunction('qrcode_data_uri', array($this, 'qrcodeDataUriFunction')));
    }
    /**
