 ...
 * QR code controller.
 */
class QrCodeController extends \Symfony\Bundle\FrameworkBundle\Controller\Controller
{
    /**
     * @Route("/{text}/{extension}", name="endroid_qrcode", requirements={"text"="[\w\W]+", "extension"="jpg|png|gif"})
     */
    public function generateAction(\Symfony\Component\HttpFoundation\Request $request, $text, $extension)
    {
        ...
        return new \Symfony\Component\HttpFoundation\Response($qrCode->get($extension), 200, array('Content-Type' => $mime_type));
    }
    /**
